...
const Skeleton = React.memo(
  forwardRef<HTMLDivElement, SkeletonProps>(
    (
      { width, height = 20, radius = 'md', circle = false, animate = true, style, ...props },
      ref
    ) => {
      ...
      return (
        <div ref={ref} data-vistral="skeleton" style={skeletonStyle} {...props}>
...
const SkeletonAvatar = React.memo(
  forwardRef<HTMLDivElement, SkeletonAvatarProps>(({ size = 40, style, ...props }, ref) => {
