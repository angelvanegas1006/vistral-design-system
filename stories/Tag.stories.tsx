    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
      ...
      <div>
        ...
        <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap', alignItems: 'center' }}>
          ...
          <Tag variant="dark" size="lg">
            Tag
          </Tag>
          <Tag variant="error" size="lg">
            Tag
          </Tag>
  ...
  render: () => (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
      <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap', alignItems: 'center' }}>
        ...
        <Tag icon={Star} variant="success">
          Featured
        </Tag>
        <Tag icon={Check} variant="info">
          Verified
        </Tag>
      </div>
    </div>
  ...
  render: () => {
    ...
    return (
      <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
        ...
        {tags.length === 0 && (
          <p style={{ margin: 0, fontSize: 14, color: '#71717a' }}>All tags removed</p>
        )}
      </div>
    )
  },
    ...
    >
      ...
      <div>
        ...
        <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap', alignItems: 'center' }}>
          ...
          <Tag closable variant="success" onClose={() => {}}>
            Tag
          </Tag>
          <Tag closable variant="error" onClose={() => {}}>
            Tag
          </Tag>
        </div>
      </div>
