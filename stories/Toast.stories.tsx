...
const MultipleToasts = () => {
  ...
  const showMultiple = () => {
    ...
    setTimeout(() => toast({ title: 'Second toast', description: 'This is the second notification', variant: 'success' }), 300);
    setTimeout(() => toast({ title: 'Third toast', description: 'This is the third notification', variant: 'warning' }), 600);
  };
...
const ToastStacking = () => {
  ...
  const showStack = () => {
    ...
    setTimeout(() => toast({ title: 'Toast 2', description: 'Second notification', variant: 'success' }), 200);
    setTimeout(() => toast({ title: 'Toast 3', description: 'Third notification', variant: 'warning' }), 400);
  };
