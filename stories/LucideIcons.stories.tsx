...
const ICON_CATEGORIES: Record<string, string[]> = {
  'Maps & Navigation': [
    'Search', 'SearchX', 'MapPin', 'MapPinOff', 'MapPinCheck', 'MapPinPlus', 'MapPinMinus',
    'MapPinned', 'Map', 'Navigation', 'Navigation2', 'Compass', 'Route', 'RouteOff',
    'Locate', 'LocateFixed', 'LocateOff', 'Globe', 'Globe2'
  ],
  'Buildings': [
    'Home', 'House', 'HousePlus', 'Building', 'Building2', 'Store', 'Warehouse',
    'Hotel', 'Hospital', 'Landmark', 'Factory', 'School', 'Church'
  ],
  'Amenities': [
    'Bed', 'BedDouble', 'BedSingle', 'Bath', 'ShowerHead', 'Sofa', 'Armchair',
    'Lamp', 'LampDesk', 'LampCeiling', 'Fence', 'Trees', 'TreePalm', 'TreePine',
    'Flower', 'Flower2', 'Waves', 'Droplets', 'Wind', 'Sun', 'Moon',
    'Tv', 'Wifi', 'Car', 'Bike', 'ParkingCircle', 'Accessibility'
  ],
  'Status & Alerts': [
    'Check', 'CheckCheck', 'CheckCircle', 'CheckCircle2', 'X', 'XCircle',
    'AlertCircle', 'AlertTriangle', 'Info', 'HelpCircle', 'Bell', 'BellOff',
    'BellPlus', 'BellMinus', 'BellRing', 'CircleAlert', 'ShieldCheck', 'ShieldX',
    'BadgeCheck', 'BadgeX', 'BadgeAlert', 'BadgeInfo'
  ],
  'Actions': [
    'Plus', 'Minus', 'PlusCircle', 'MinusCircle', 'Edit', 'Edit2', 'Edit3',
    'Pencil', 'PenLine', 'Trash', 'Trash2', 'Copy', 'Clipboard', 'Download',
    'Upload', 'Share', 'Share2', 'ExternalLink', 'Link', 'Unlink',
    'Eye', 'EyeOff', 'Lock', 'Unlock', 'Key', 'Settings', 'Settings2',
    'Sliders', 'SlidersHorizontal', 'Filter', 'FilterX', 'RefreshCw', 'RefreshCcw',
    'RotateCw', 'RotateCcw', 'Undo', 'Redo', 'Save', 'FolderOpen', 'FileText'
  ],
  'Arrows & Chevrons': [
    ...
    'ChevronFirst', 'ChevronLast', 'ArrowUpDown', 'ArrowLeftRight',
    'MoveUp', 'MoveDown', 'MoveLeft', 'MoveRight', 'Move',
    'Maximize', 'Minimize', 'Maximize2', 'Minimize2', 'Expand', 'Shrink'
  ],
  'UI Elements': [
    'Menu', 'MoreHorizontal', 'MoreVertical', 'Grid', 'Grid2X2', 'Grid3X3',
    'LayoutGrid', 'LayoutList', 'LayoutTemplate', 'List', 'ListOrdered',
    'Table', 'Table2', 'Columns', 'Rows', 'PanelLeft', 'PanelRight',
    'PanelTop', 'PanelBottom', 'Sidebar', 'SidebarOpen', 'SidebarClose',
    'Layers', 'Layers2', 'Layers3', 'Square', 'Circle', 'Triangle'
  ],
  'User & People': [
    'User', 'UserPlus', 'UserMinus', 'UserCheck', 'UserX', 'UserCog',
    'UserCircle', 'UserCircle2', 'Users', 'Users2', 'Contact', 'Contact2',
    'UserRound', 'UserRoundPlus', 'UserRoundMinus', 'UserRoundCheck', 'UserRoundX',
    'UsersRound', 'CircleUser', 'CircleUserRound'
  ],
  'Time & Calendar': [
    'Calendar', 'CalendarDays', 'CalendarCheck', 'CalendarCheck2', 'CalendarX',
    'CalendarPlus', 'CalendarMinus', 'CalendarClock', 'CalendarSearch',
    'CalendarRange', 'CalendarHeart', 'Clock', 'Clock1', 'Clock2', 'Clock3',
    'Clock4', 'Clock5', 'Clock6', 'Clock7', 'Clock8', 'Clock9', 'Clock10',
    'Clock11', 'Clock12', 'Timer', 'TimerOff', 'TimerReset', 'Hourglass',
    'History', 'AlarmClock', 'AlarmClockOff', 'Watch', 'Stopwatch'
  ],
  'Communication': [
    ...
    'VolumeX', 'Send', 'SendHorizontal', 'Reply', 'ReplyAll', 'Forward'
  ],
  'Media & Files': [
    'Image', 'Images', 'Camera', 'CameraOff', 'Video', 'Film', 'Music',
    'Music2', 'Headphones', 'Play', 'Pause', 'PlayCircle', 'PauseCircle',
    'SkipBack', 'SkipForward', 'Rewind', 'FastForward', 'File', 'FileText',
    'FileImage', 'FileVideo', 'FileAudio', 'FilePlus', 'FileMinus', 'FileCheck',
    'FileX', 'Folder', 'FolderOpen', 'FolderPlus', 'FolderMinus', 'FolderCheck'
  ],
  'Commerce': [
    'ShoppingCart', 'ShoppingBag', 'Package', 'Package2', 'PackageCheck',
    'PackageX', 'PackagePlus', 'PackageMinus', 'PackageSearch', 'PackageOpen',
    'Truck', 'CreditCard', 'Wallet', 'Wallet2', 'Receipt', 'Tag', 'Tags',
    'Percent', 'DollarSign', 'Euro', 'PoundSterling', 'Banknote', 'Coins',
    'PiggyBank', 'Landmark', 'Store', 'Building', 'Building2'
  ],
  'Social & Favorites': [
    'Heart', 'HeartOff', 'HeartCrack', 'HeartHandshake', 'ThumbsUp', 'ThumbsDown',
    'Star', 'StarOff', 'StarHalf', 'Bookmark', 'BookmarkPlus', 'BookmarkMinus',
    'BookmarkCheck', 'BookmarkX', 'Flag', 'FlagOff', 'Award', 'Trophy',
    'Medal', 'Crown', 'Gem', 'Gift', 'Cake', 'PartyPopper'
  ],
};
...
const CategorySection: React.FC<CategorySectionProps> = ({ category, iconNames, iconSize = 24 }) => {
...
export const MapsNavigation: Story = {
  ...
  render: () => (
    <div style={{ padding: '32px', fontFamily: 'system-ui, sans-serif' }}>
      <CategorySection category="Maps & Navigation" iconNames={ICON_CATEGORIES['Maps & Navigation']} />
    </div>
  ),
};
              ...
              <div style={{ display: 'flex', alignItems: 'end', gap: '24px' }}>
                {sizes.map(size => (
                  <div key={size} style={{ textAlign: 'center' }}>
                    <Icon size={size} />
                    <span style={{ display: 'block', marginTop: '8px', fontSize: '10px', color: '#9ca3af' }}>
                      {size}px
                    </span>
                  </div>
                ))}
        ...
        <div style={{ display: 'flex', gap: '32px', flexWrap: 'wrap' }}>
          {colors.map(({ name, value }) => (
            <div key={name} style={{ textAlign: 'center' }}>
              ...
              <span style={{ display: 'block', marginTop: '8px', fontSize: '12px', color: '#6b7280' }}>
                {name}
              </span>
  ...
  render: () => {
    ...
    return (
      <div style={{ padding: '32px', fontFamily: 'system-ui, sans-serif' }}>
        ...
        {/* Button */}
        <div style={{ marginBottom: '32px' }}>
          <h3 style={{ margin: '0 0 12px', fontSize: '14px', fontWeight: '500' }}>Button with Icon</h3>
