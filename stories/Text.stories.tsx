  ...
  render: () => (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
      <Text variant="h3" as="div">
        Rendered as div (h3 style)
      </Text>
      <Text variant="body" as="span">
        Rendered as span (body style)
      </Text>
      <Text variant="caption" as="p">
        Rendered as paragraph (caption style)
      </Text>
    </div>
  ),
}
...
export const CustomSize: Story = {
  render: () => (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
      ...
      <Text variant="body" size={20}>
        Custom size: 20px
      </Text>
      <Text variant="body" size="1.5rem">
        Custom size: 1.5rem
      </Text>
    </div>
  ),
  ...
  render: () => (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 24, maxWidth: 600 }}>
      ...
      <div>
        <Text variant="h4">Heading 4</Text>
        <Text variant="caption" color="muted">
          18px, Semibold, Line height 1.4
        </Text>
      </div>
      <div>
        <Text variant="h5">Heading 5</Text>
        <Text variant="caption" color="muted">
          16px, Semibold, Line height 1.5
        </Text>
      </div>
      <div>
        <Text variant="h6">Heading 6</Text>
        <Text variant="caption" color="muted">
          14px, Semibold, Line height 1.5
        </Text>
      </div>
      <div>
    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: 32, maxWidth: 600 }}>
      <div>
        ...
        <Text variant="body" style={{ marginBottom: 12 }}>
          This is the main content of the article. It uses the body variant for readability and
          maintains proper line height for comfortable reading.
        </Text>
        <Text variant="body">
          Additional paragraphs continue with the same styling to maintain consistency throughout
          the document.
        </Text>
      </div>
