    ...
    >
      ...
      <div>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
          ...
          <div style={{ display: 'flex', gap: 8, alignItems: 'center' }}>
            <span style={{ width: 100, fontSize: 12, color: '#71717a' }}>Active:</span>
            <Chip variant="outlined" selected active>
              Label
            </Chip>
          </div>
          <div style={{ display: 'flex', gap: 8, alignItems: 'center' }}>
            <span style={{ width: 100, fontSize: 12, color: '#71717a' }}>Disabled:</span>
            <Chip variant="outlined" selected disabled>
              Label
            </Chip>
          </div>
        </div>
  ...
  render: () => (
    ...
    >
      ...
      <div>
        ...
        <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap' }}>
          <Chip variant="filled" rightElement="dropdown">
            Label
          </Chip>
          <Chip variant="filled" rightElement="dropdown" active>
            Label
          </Chip>
          <Chip variant="outlined" selected rightElement="dropdown">
            Label
          </Chip>
          <Chip variant="outlined" selected rightElement="dropdown" active>
            Label
          </Chip>
        </div>
      </div>
      ...
      <div>
        ...
        <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap' }}>
          <Chip variant="filled" rightElement="count" count={9}>
            Label
          </Chip>
          <Chip variant="filled" rightElement="count" count={9} selected>
            Label
          </Chip>
          <Chip variant="outlined" selected rightElement="count" count={9}>
            Label
          </Chip>
        </div>
      </div>
      ...
      <div>
        ...
        <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap' }}>
          <Chip variant="filled" rightElement="remove">
            Label
          </Chip>
          <Chip variant="filled" rightElement="remove" selected>
            Label
          </Chip>
          <Chip variant="outlined" selected rightElement="remove">
            Label
          </Chip>
        </div>
      </div>
      ...
      <div>
        ...
        <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap' }}>
          <Chip variant="filled" rightElement="count" count={9} showDivider>
            Label
          </Chip>
          <Chip variant="filled" rightElement="dropdown" showDivider>
            Label
          </Chip>
          <Chip variant="outlined" selected rightElement="remove" showDivider>
            Label
          </Chip>
        </div>
      </div>
    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
      <div>
        ...
        <div style={{ display: 'flex', gap: 8, alignItems: 'center' }}>
          ...
          <Chip size="sm" leftIcon={Tag}>
            With Icon
          </Chip>
          <Chip size="sm" rightElement="remove">
            Removable
          </Chip>
        </div>
      </div>
      ...
      <div>
        ...
        <div style={{ display: 'flex', gap: 8, alignItems: 'center' }}>
          ...
          <Chip size="md" leftIcon={Tag}>
            With Icon
          </Chip>
          <Chip size="md" rightElement="remove">
            Removable
          </Chip>
        </div>
      </div>
...
export const WithIcons: Story = {
  render: () => (
    <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap' }}>
      ...
      <Chip leftIcon={Tag} rightElement="dropdown">
        With Dropdown
      </Chip>
      <Chip leftIcon={Star} rightElement="count" count={5}>
        With Count
      </Chip>
    </div>
  ),
...
export const FilterExample: Story = {
  ...
  render: () => {
    ...
    return (
      ...
      >
        <h3 style={{ margin: '0 0 12px', fontSize: 14, fontWeight: 600 }}>Bedrooms</h3>
        <ChipGroup>
          {filters.map(filter => (
            <Chip
              key={filter}
  ...
  render: () => {
    ...
    return (
      <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
        ...
        {activeChip && <p style={{ fontSize: 12, color: '#71717a' }}>Active: {activeChip}</p>}
      </div>
    )
  },
}
  ...
  render: () => (
    ...
    >
      ...
      <div>
        ...
        <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap' }}>
          <Chip variant="filled" leftIcon={Tag}>
            Label
          </Chip>
          <Chip variant="filled" leftIcon={Tag} rightElement="dropdown">
            Label
          </Chip>
          <Chip variant="outlined" selected leftIcon={Star}>
            Label
          </Chip>
          <Chip variant="outlined" selected leftIcon={Filter} rightElement="count" count={5}>
            Label
          </Chip>
        </div>
      </div>
