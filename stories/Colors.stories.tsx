      ...
      <div style={{ padding: "12px", display: "flex", flexDirection: "column", gap: "8px" }}>
        ...
        <div style={{ display: "flex", gap: "8px", marginTop: "4px" }}>
          ...
          >
            ...
            />
            <span style={{ color: wcagWhite.color, fontWeight: 600 }}>
              {wcagWhite.level}
            </span>
          </div>
          <div
          ...
          >
            ...
            />
            <span style={{ color: wcagBlack.color, fontWeight: 600 }}>
              {wcagBlack.level}
            </span>
          </div>
        </div>
 ...
 */
function groupColorsByFamily(colors: Record<string, string>): Record<string, Record<string, string>> {
...
export const Primary: Story = {
  render: () => {
    ...
    const renderGroup = (title: string, familyNames: string[]) => {
      ...
      return (
        <div style={{ marginBottom: "48px" }}>
          <h4 style={{ fontSize: "16px", fontWeight: 600, color: "#6b7280", marginBottom: "16px", textTransform: "uppercase", letterSpacing: "0.05em" }}>
            {title}
          </h4>
    ...
    return (
      <div style={{ padding: "48px", maxWidth: "1400px", margin: "0 auto" }}>
        ...
        <p style={{ color: "#6b7280", fontSize: "16px", marginBottom: "32px", maxWidth: "700px", lineHeight: 1.6 }}>
      ...
      <div style={{ padding: "48px", maxWidth: "1400px", margin: "0 auto" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(300px, 1fr))", gap: "32px" }}>
          {Object.entries(families).map(([family, colors]) => (
            <div key={family} style={{ background: "#f9fafb", borderRadius: "12px", padding: "24px" }}>
              <h3 style={{ fontSize: "18px", fontWeight: 600, marginBottom: "16px", textTransform: "capitalize", color: "#18181b" }}>
                {family}
              </h3>
    ...
    return (
      <div style={{ padding: "48px", maxWidth: "1400px", margin: "0 auto" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: "24px" }}>
          {Object.entries(families).map(([family, colors]) => (
            <div key={family} style={{ background: family.includes("dark") ? "#18181b" : "#ffffff", borderRadius: "12px", padding: "20px", border: "1px solid #e5e7eb" }}>
              <h3 style={{ fontSize: "16px", fontWeight: 600, marginBottom: "12px", textTransform: "capitalize", color: family.includes("dark") ? "#ffffff" : "#18181b" }}>
                {family.replace(/-/g, " ")}
              </h3>
    ...
    return (
      <div style={{ padding: "48px", maxWidth: "800px", margin: "0 auto" }}>
        ...
        <p style={{ color: "#6b7280", marginBottom: "32px", lineHeight: 1.6 }}>
          ...
          WCAG 2.2 requires a minimum contrast ratio of 4.5:1 for normal text (AA)
          and 7:1 for enhanced contrast (AAA).
        </p>
        ...
        >
          ...
          <p style={{ fontSize: "16px", lineHeight: 1.6 }}>
            The quick brown fox jumps over the lazy dog. This sample text helps you
            evaluate the readability of your color combination.
          </p>
        </div>
        ...
        >
          ...
          <div>
            ...
            <div style={{ fontSize: "32px", fontWeight: 700, color: wcag.color }}>
              {wcag.level}
            </div>
          </div>
