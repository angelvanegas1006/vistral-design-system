...
export const AllStates: Story = {
  ...
  render: () => (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
      <div>
        <p style={{ margin: '0 0 8px', fontSize: 12, color: '#71717a', fontWeight: 500 }}>
          DEFAULT
        </p>
  ...
  render: () => (
    <div style={{ maxWidth: 500 }}>
      <p style={{ lineHeight: 1.7, fontSize: 14, color: '#3f3f46' }}>
        ...
        <Link href="#">Privacy Policy</Link>. If you have any questions, please{' '}
...
export const Navigation: Story = {
  render: () => (
    ...
    >
      <Link href="#" underline="none" style={{ color: '#71717a' }}>
        Home
      </Link>
      <Link href="#" underline="none" style={{ color: '#71717a' }}>
        Products
  ...
  render: () => (
    ...
    >
      <div style={{ display: 'flex', gap: 48, marginBottom: 24 }}>
        <div>
          <h4 style={{ color: '#fff', margin: '0 0 12px', fontSize: 14, fontWeight: 600 }}>
            Company
          </h4>
          <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
            <Link href="#" underline="hover" style={{ color: '#a1a1aa' }}>
              About
            </Link>
            <Link href="#" underline="hover" style={{ color: '#a1a1aa' }}>
              Careers
        ...
        <div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
            <Link href="https://twitter.com" external style={{ color: '#a1a1aa' }}>
              Twitter
            </Link>
            <Link href="https://github.com" external style={{ color: '#a1a1aa' }}>
              GitHub
            </Link>
            <Link href="https://linkedin.com" external style={{ color: '#a1a1aa' }}>
              LinkedIn
            </Link>
          </div>
        </div>
