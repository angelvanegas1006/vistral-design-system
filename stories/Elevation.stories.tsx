      ...
      <div style={{ padding: "48px", maxWidth: "1200px", margin: "0 auto", fontFamily: "Inter, system-ui, sans-serif" }}>
        ...
        <div style={{ marginBottom: "48px" }}>
          ...
          <p style={{ color: "#6b7280", fontSize: "16px", lineHeight: 1.7, maxWidth: "700px" }}>
            Elevation creates visual hierarchy through shadows and z-index stacking.
            Higher elevation means elements appear closer to the user.
          </p>
        </div>
        ...
        <section style={{ marginBottom: "64px" }}>
          ...
          <div style={{ background: "#ffffff", borderRadius: "12px", border: "1px solid #e5e7eb", overflow: "hidden" }}>
            ...
            {[
              { level: 0, zIndex: 0, usage: "Base content", components: "Page content, backgrounds" },
              { level: 1, zIndex: 10, usage: "Subtle elevation", components: "Cards, list items, form fields" },
              { level: 2, zIndex: 20, usage: "Overlays on content", components: "Dropdowns, popovers, tooltips" },
              { level: 3, zIndex: 30, usage: "Primary overlays", components: "Modals, dialogs, sidesheets" },
              { level: 4, zIndex: 40, usage: "Urgent content", components: "Toasts, notifications, alerts" },
              { level: 5, zIndex: 50, usage: "Critical overlays", components: "System dialogs, loading screens" },
            ].map((row) => (
              <div
                key={row.level}
                style={{
              ...
              >
                <div style={{ fontWeight: 600, fontSize: "16px", color: "#3b82f6" }}>{row.level}</div>
                <div style={{ fontSize: "14px", fontFamily: "monospace", color: "#6b7280" }}>{row.zIndex}</div>
        ...
        <section>
          ...
          >
            ...
            >
              <div style={{ padding: "12px 16px", borderBottom: "1px solid #f3f4f6", fontWeight: 500, fontSize: "13px" }}>
                Level 2 Menu
              </div>
              {["Item 1", "Item 2"].map((item) => (
                <div key={item} style={{ padding: "10px 16px", fontSize: "13px", color: "#374151" }}>
                  {item}
                </div>
              ))}
            </div>
            ...
            >
              ...
              <div style={{ fontSize: "13px", color: "#6b7280", marginBottom: "16px" }}>z-index: 30</div>
              <button
                style={{
                  padding: "8px 16px",
                  background: "#3b82f6",
