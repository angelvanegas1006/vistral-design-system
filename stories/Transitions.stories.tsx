      ...
      <div style={{ padding: "48px", maxWidth: "1200px", margin: "0 auto", fontFamily: "Inter, system-ui, sans-serif" }}>
        ...
        <div style={{ marginBottom: "48px" }}>
          ...
          <p style={{ color: "#6b7280", fontSize: "16px", lineHeight: 1.7, maxWidth: "700px" }}>
            Transitions provide visual feedback and create smooth state changes.
            Consistent timing and easing make interactions feel natural.
          </p>
        </div>
            ...
            {Object.entries(transitions.duration || {}).map(([name, value]) => {
              ...
              return (
                ...
                >
                  ...
                  <div style={{ flex: 1, height: "40px", background: "#f3f4f6", borderRadius: "8px", overflow: "hidden" }}>
                    <div
                      style={{
        ...
        <section style={{ marginBottom: "64px" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: "16px" }}>
            {Object.entries(transitions.easing || {}).map(([name, value]) => (
              ...
              >
                <div style={{ fontWeight: 600, fontSize: "14px", marginBottom: "4px", color: "#18181b" }}>
                  {name}
                </div>
                <div
                  style={{
        ...
        <section>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: "24px" }}>
            ...
            <div style={{ background: "#f9fafb", borderRadius: "12px", padding: "24px" }}>
              <div style={{ fontSize: "14px", fontWeight: 600, marginBottom: "16px" }}>Button Hover</div>
              <button
                style={{
                  padding: "12px 24px",
                  background: "#3b82f6",
              ...
              <div style={{ fontSize: "12px", color: "#6b7280", marginTop: "12px", fontFamily: "monospace" }}>
            ...
            {/* Scale on press */}
            <div style={{ background: "#f9fafb", borderRadius: "12px", padding: "24px" }}>
              <div style={{ fontSize: "14px", fontWeight: 600, marginBottom: "16px" }}>Press Scale</div>
              <button
                style={{
                  padding: "12px 24px",
                  background: "#18181b",
            ...
            {/* Fade in */}
            <div style={{ background: "#f9fafb", borderRadius: "12px", padding: "24px" }}>
              <div style={{ fontSize: "14px", fontWeight: 600, marginBottom: "16px" }}>Fade Toggle</div>
              <FadeDemo />
              <div style={{ fontSize: "12px", color: "#6b7280", marginTop: "12px", fontFamily: "monospace" }}>
            ...
            {/* Slide */}
            <div style={{ background: "#f9fafb", borderRadius: "12px", padding: "24px" }}>
              <div style={{ fontSize: "14px", fontWeight: 600, marginBottom: "16px" }}>Slide Toggle</div>
              <SlideDemo />
              <div style={{ fontSize: "12px", color: "#6b7280", marginTop: "12px", fontFamily: "monospace" }}>
    ...
    return (
      <div style={{ padding: "48px", maxWidth: "1200px", margin: "0 auto", fontFamily: "Inter, system-ui, sans-serif" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(300px, 1fr))", gap: "32px" }}>
          {[
            { name: "ease-out", value: "cubic-bezier(0, 0, 0.2, 1)", desc: "Quick start, slow end. Best for entrances." },
            { name: "ease-in", value: "cubic-bezier(0.4, 0, 1, 1)", desc: "Slow start, quick end. Best for exits." },
            { name: "ease-in-out", value: "cubic-bezier(0.4, 0, 0.2, 1)", desc: "Slow start and end. Best for movement." },
            { name: "linear", value: "linear", desc: "Constant speed. Best for loading indicators." },
            { name: "bounce", value: "cubic-bezier(0.68, -0.55, 0.265, 1.55)", desc: "Overshoots then settles. Use sparingly." },
          ].map((easing) => (
            <div
              key={easing.name}
              style={{
            ...
            >
              <div style={{ fontWeight: 600, fontSize: "16px", marginBottom: "4px" }}>{easing.name}</div>
              <div style={{ fontSize: "12px", color: "#6b7280", marginBottom: "16px" }}>{easing.desc}</div>
