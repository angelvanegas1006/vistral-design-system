...
export const Default: Story = {
  render: () => {
    ...
    return <FullPagination page={page} totalPages={10} onPageChange={setPage} />
  },
}
...
export const WithFirstLast: Story = {
  render: () => {
    ...
    return <FullPagination page={page} totalPages={20} onPageChange={setPage} showFirstLast />
  },
}
...
export const FewPages: Story = {
  render: () => {
    ...
    return <FullPagination page={page} totalPages={3} onPageChange={setPage} />
  },
}
  ...
  render: () => {
    ...
    return (
      <Pagination>
        ...
        <PaginationButton active={page === 2} onClick={() => setPage(2)}>
          2
        </PaginationButton>
        <PaginationButton active={page === 3} onClick={() => setPage(3)}>
          3
        </PaginationButton>
        <PaginationButton active={page === 4} onClick={() => setPage(4)}>
          4
        </PaginationButton>
        <PaginationButton active={page === 5} onClick={() => setPage(5)}>
          5
        </PaginationButton>
  ...
  render: () => {
    ...
    return (
      ...
      >
        ...
        <FullPagination page={page} totalPages={totalPages} onPageChange={setPage} />
      </div>
    )
  },
}
