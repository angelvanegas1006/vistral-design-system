...
function RadiusExampleCard({
  ...
  return (
    <div style={{ textAlign: "center" }}>
      <div style={{ marginBottom: "12px", height: "80px", display: "flex", alignItems: "center", justifyContent: "center" }}>
        {renderElement()}
      </div>
      <div style={{ fontSize: "12px", color: "#6b7280" }}>{title}</div>
      <div style={{ fontSize: "11px", color: "#9ca3af", fontFamily: "monospace" }}>{radiusValue}</div>
    </div>
  )
}
      ...
      <div style={{ padding: "48px", maxWidth: "1200px", margin: "0 auto", fontFamily: "Inter, system-ui, sans-serif" }}>
        ...
        <div style={{ marginBottom: "48px" }}>
          ...
          <p style={{ color: "#6b7280", fontSize: "16px", lineHeight: 1.7, maxWidth: "700px" }}>
            Consistent spacing and border radius values create visual rhythm and harmony.
            Our scale is based on a 4px grid for precise alignment.
          </p>
        </div>
    ...
    return (
      <div style={{ padding: "48px", maxWidth: "1200px", margin: "0 auto", fontFamily: "Inter, system-ui, sans-serif" }}>
        ...
        <p style={{ color: "#6b7280", fontSize: "16px", marginBottom: "48px", maxWidth: "600px", lineHeight: 1.6 }}>
          Our spacing scale follows a 4px grid system. Each step increases predictably
          to maintain visual consistency across the interface.
        </p>
            ...
            .map(([name, value]) => {
              ...
              return (
                <div key={name} style={{ display: "flex", alignItems: "center", gap: "16px" }}>
                  <div style={{ width: "60px", fontSize: "14px", fontWeight: 600, color: "#18181b" }}>
                    {name}
                  </div>
  ...
  render: () => {
    ...
    return (
      <div style={{ padding: "48px", maxWidth: "1200px", margin: "0 auto", fontFamily: "Inter, system-ui, sans-serif" }}>
        ...
        <p style={{ color: "#6b7280", fontSize: "16px", marginBottom: "48px", maxWidth: "600px", lineHeight: 1.6 }}>
          Consistent border radius creates visual harmony. Use smaller values for
          compact elements and larger values for prominent containers.
        </p>
          ...
          <div>
            ...
            >
              <div style={{ display: "flex", gap: "16px", marginBottom: "16px" }}>
                ...
                <div>
                  <div style={{ fontWeight: 600, fontSize: "16px", marginBottom: "4px" }}>Analytics</div>
            ...
            <div style={{ marginTop: "12px", fontSize: "12px", color: "#9ca3af", fontFamily: "monospace" }}>
