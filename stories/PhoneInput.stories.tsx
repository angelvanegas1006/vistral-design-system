...
export const Disabled: Story = {
  ...
  render: () => (
    <div style={{ width: 400 }}>
      <PhoneInput value="" countryCode="ES" label="Label" disabled placeholder="Phone number" />
    </div>
  ),
}
...
export const DisabledFilled: Story = {
  ...
  render: () => (
    <div style={{ width: 400 }}>
      <PhoneInput value="696 765 496" countryCode="ES" label="Label" disabled />
    </div>
  ),
}
...
export const AllStates: Story = {
  ...
  render: () => (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 24, width: 400 }}>
      <PhoneInput value="" countryCode="ES" label="Label" placeholder="Phone number" />
      <PhoneInput value="696 765 496" countryCode="ES" label="Label" />
      <PhoneInput value="" countryCode="ES" label="Label" disabled placeholder="Phone number" />
      <PhoneInput value="693" countryCode="ES" label="Label" />
      <PhoneInput
        value=""
        countryCode="ES"
        label="Label"
