  ...
  return (
    ...
    >
      ...
      <div>
        ...
        <div style={{ fontSize: "12px", color: "#6b7280", fontFamily: "monospace" }}>{fontSize}</div>
      </div>
  ...
  return (
    ...
    >
      <div style={{ width: "120px" }}>
        <div style={{ fontWeight: 600, fontSize: "14px", color: "#18181b", textTransform: "capitalize" }}>
          {name}
        </div>
      ...
      <div style={{ padding: "48px", maxWidth: "1200px", margin: "0 auto", fontFamily: "Inter, system-ui, sans-serif" }}>
        ...
        <div style={{ marginBottom: "48px" }}>
          ...
          <p style={{ color: "#6b7280", fontSize: "16px", lineHeight: 1.7, maxWidth: "700px" }}>
            ...
            with a carefully crafted scale that ensures readability and visual hierarchy across all contexts.
          </p>
        </div>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: "24px" }}>
            {Object.entries(tokens.typography?.fontFamily || {}).map(([name, family]) => (
              ...
              >
                ...
                <div style={{ fontSize: "48px", fontWeight: 500, fontFamily: family, marginBottom: "16px" }}>
                  Aa
                </div>
        ...
        <section style={{ marginBottom: "64px" }}>
          ...
          <div style={{ background: "#ffffff", borderRadius: "12px", border: "1px solid #e5e7eb", padding: "0 16px" }}>
    ...
    return (
      <div style={{ padding: "48px", maxWidth: "1200px", margin: "0 auto", fontFamily: "Inter, system-ui, sans-serif" }}>
        ...
        <p style={{ color: "#6b7280", fontSize: "16px", marginBottom: "48px", maxWidth: "600px", lineHeight: 1.6 }}>
          Our modular type scale provides consistent sizing across the interface.
          Each size is paired with an appropriate line height for optimal readability.
        </p>
          ...
          {Object.entries(fontSizes)
            ...
            .map(([name, size]) => (
              <div key={name} style={{ display: "flex", alignItems: "baseline", gap: "24px" }}>
                <div style={{ width: "80px", fontSize: "12px", color: "#6b7280", fontFamily: "monospace" }}>
                  {name}
                </div>
                <div style={{ width: "60px", fontSize: "12px", color: "#9ca3af", fontFamily: "monospace" }}>
                  {size}
                </div>
                <div
                  style={{
  ...
  render: () => {
    ...
    return (
      <div style={{ padding: "48px", maxWidth: "1200px", margin: "0 auto", fontFamily: "Inter, system-ui, sans-serif" }}>
        ...
        <p style={{ color: "#6b7280", fontSize: "16px", marginBottom: "48px", maxWidth: "600px", lineHeight: 1.6 }}>
          Using the right font weight helps establish visual hierarchy and guides
          the reader's eye through your content.
        </p>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "32px" }}>
          {Object.entries(fontWeights)
            ...
            .map(([name, weight]) => (
              <div key={name}>
                <div style={{ fontSize: "12px", color: "#6b7280", marginBottom: "8px", textTransform: "capitalize" }}>
                  {name} ({weight})
                </div>
                <div
                  style={{
    ...
    return (
      <div style={{ padding: "48px", maxWidth: "1200px", margin: "0 auto", fontFamily: "Inter, system-ui, sans-serif" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(350px, 1fr))", gap: "24px" }}>
          ...
          <UsageCard
            title="Page Header"
            description="3xl/semibold + base/regular"
          >
            <div style={{ fontFamily }}>
              <h1 style={{ fontSize: "48px", fontWeight: 600, marginBottom: "16px", lineHeight: "58px" }}>
                Dashboard
              </h1>
              <p style={{ fontSize: "16px", fontWeight: 400, color: "#6b7280", lineHeight: "24px" }}>
          ...
          <UsageCard
            ...
            description="xl/semibold + caption/regular"
          >
            <div style={{ fontFamily }}>
              <h2 style={{ fontSize: "32px", fontWeight: 600, marginBottom: "8px", lineHeight: "38px" }}>
                Recent Orders
              </h2>
              <p style={{ fontSize: "14px", fontWeight: 400, color: "#6b7280", lineHeight: "20px" }}>
          ...
          <UsageCard
            title="Card Title"
            description="md/medium + small/regular"
          >
            <div style={{ fontFamily }}>
              <h3 style={{ fontSize: "20px", fontWeight: 500, marginBottom: "8px", lineHeight: "28px" }}>
                Revenue Overview
              </h3>
              <p style={{ fontSize: "12px", fontWeight: 400, color: "#6b7280", lineHeight: "16px" }}>
                Total revenue for the current quarter
              </p>
              <div style={{ fontSize: "36px", fontWeight: 600, marginTop: "16px" }}>
                $124,500
              </div>
            </div>
          </UsageCard>
          ...
          <UsageCard
            title="Body Text"
            description="base/regular paragraph"
          >
            <div style={{ fontFamily }}>
              <p style={{ fontSize: "16px", fontWeight: 400, lineHeight: "24px", marginBottom: "16px" }}>
                This is a standard body paragraph. It uses our base size with regular weight
                for optimal readability in long-form content.
              </p>
              <p style={{ fontSize: "16px", fontWeight: 400, lineHeight: "24px" }}>
                Multiple paragraphs maintain consistent spacing. Use <strong style={{ fontWeight: 600 }}>semibold</strong> for
          ...
          <UsageCard
            ...
            description="small/medium + xs/regular"
          >
            <div style={{ fontFamily }}>
              <div style={{ marginBottom: "16px" }}>
                ...
                <div style={{ padding: "10px 12px", border: "1px solid #e5e7eb", borderRadius: "6px", fontSize: "14px" }}>
                  user@example.com
                </div>
          ...
          <UsageCard
            title="Dark Mode"
            description="Typography on dark backgrounds"
            dark
          >
            <div style={{ fontFamily }}>
              <h3 style={{ fontSize: "24px", fontWeight: 600, marginBottom: "8px", lineHeight: "32px" }}>
                Dark Theme
              </h3>
              <p style={{ fontSize: "14px", fontWeight: 400, color: "#a3a3a3", lineHeight: "20px" }}>
                Text colors are adjusted for proper contrast on dark backgrounds.
                Primary text uses white, secondary text uses neutral-400.
              </p>
            </div>
          </UsageCard>
        </div>
...
export const LineHeights: Story = {
  render: () => {
    ...
    const sampleText = "Typography is the art and technique of arranging type to make written language legible, readable and appealing when displayed. The arrangement of type involves selecting typefaces, point sizes, line lengths, line-spacing, and letter-spacing."
    ...
    return (
      <div style={{ padding: "48px", maxWidth: "1200px", margin: "0 auto", fontFamily: "Inter, system-ui, sans-serif" }}>
        ...
        <p style={{ color: "#6b7280", fontSize: "16px", marginBottom: "48px", maxWidth: "600px", lineHeight: 1.6 }}>
          Proper line height improves readability by giving text room to breathe.
          Each font size has an optimized line height.
        </p>
