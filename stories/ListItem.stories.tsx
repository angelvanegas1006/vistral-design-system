...
export const Default: Story = {
  render: () => (
    <div
      style={{ width: 400, backgroundColor: '#fff', borderRadius: 12, border: '1px solid #e4e4e7' }}
    >
      <List>
        <Item title="Title" />
        <Item title="Title" />
...
export const WithDescription: Story = {
  ...
  render: () => (
    ...
    >
      <List>
        <Item title="Title" description="This is a card description." />
        <Item title="Title" description="This is a card description." />
        <Item title="Title" description="This is a card description." />
      </List>
    </div>
    ...
    >
      <List>
        ...
        <Item
          ...
          clickable
        />
        <Item leadingIcon={Settings} title="Settings" showChevron clickable />
      </List>
    </div>
  ),
}
  ...
  render: () => (
    ...
    >
      <List>
        ...
        />
        <Item leadingIcon={Bluetooth} title="Bluetooth" description="Off" actions={<Switch />} />
        <Item
          title="Title"
          description="This is a card description."
          actions={
...
export const WithDividers: Story = {
  ...
  render: () => (
    ...
    >
      <List>
        <Item title="Title" description="This is a card description." showDivider />
        <Item title="Title" description="This is a card description." showDivider />
        <Item title="Title" description="This is a card description." />
      </List>
    </div>
...
export const States: Story = {
  ...
  render: () => (
    ...
    >
      <List>
        <Item title="Default State" description="Hover to see effect" clickable />
        <Item title="Selected State" description="This item is selected" selected clickable />
        <Item title="Disabled State" description="This item is disabled" disabled clickable />
      </List>
    </div>
  ),
}
...
export const LongContent: Story = {
  ...
  render: () => (
    ...
    >
      <List>
        <Item title="Short Content" description="Short description" />
        <Item
  ...
  render: () => (
    ...
    >
      <List>
        ...
        />
        <Item leadingIcon={Bluetooth} title="Bluetooth" description="Off" actions={<Switch />} />
        <Item leadingIcon={Moon} title="Dark Mode" actions={<Switch />} />
        <Item leadingIcon={Bell} title="Notifications" actions={<Switch defaultChecked />} />
      </List>
    </div>
  ),
}
      ...
      <List divided>
        {[
          ...
          <Item
            ...
            media={
              <Avatar name={contact.name} size="md" showStatus status={contact.status as any} />
            }
            showChevron
            clickable
          />
