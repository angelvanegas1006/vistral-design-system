        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
          {(
            ...
            >
              ...
              <Button variant={variant} iconOnly aria-label="Add">
                <Plus size={18} />
              </Button>
    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
      <div>
        ...
        <div style={{ display: 'flex', gap: 12, flexWrap: 'wrap' }}>
          ...
          <Button leftIcon={Trash2} variant="destructive-outline">
            Delete
          </Button>
        </div>
      </div>
      ...
      <div>
        ...
        <div style={{ display: 'flex', gap: 12 }}>
          ...
          <Button iconOnly variant="destructive-outline" aria-label="Remove">
            <Trash2 size={18} />
          </Button>
          <Button iconOnly variant="destructive-ghost" aria-label="Remove">
            <Trash2 size={18} />
          </Button>
        </div>
      </div>
...
export const Examples: Story = {
  ...
  render: () => (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 32, maxWidth: 400 }}>
      ...
      >
        <Button variant="ghost" iconOnly size="sm" aria-label="Search">
          <Search size={16} />
        </Button>
        <Button variant="ghost" iconOnly size="sm" aria-label="Add">
          <Plus size={16} />
        </Button>
        <Button variant="ghost" iconOnly size="sm" aria-label="Download">
          <Download size={16} />
        </Button>
        <div style={{ flex: 1 }} />
        <Button variant="ghost" iconOnly size="sm" aria-label="Settings">
          <Settings size={16} />
        </Button>
      </div>
    </div>
      ...
      {(
        ...
        >
          ...
          <div style={{ display: 'flex', gap: 12, alignItems: 'center', flexWrap: 'wrap' }}>
            ...
            <Button variant={variant} rightIcon={ChevronRight}>
              Button
            </Button>
            <Button variant={variant} iconOnly aria-label="Icon">
              <Plus size={18} />
            </Button>
            <Button variant={variant} isLoading>
              Loading
