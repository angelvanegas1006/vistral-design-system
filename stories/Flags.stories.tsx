...
const REGIONS: Record<string, string[]> = {
  'North America': ['united-states', 'canada', 'mexico', 'guatemala', 'belize', 'honduras', 'el-salvador', 'nicaragua', 'costa-rica', 'panama', 'cuba', 'jamaica', 'haiti', 'dominican-republic', 'puerto-rico', 'bahamas', 'barbados', 'trinidad-and-tobago'],
  'South America': ['brazil', 'argentina', 'colombia', 'peru', 'venezuela', 'chile', 'ecuador', 'bolivia', 'paraguay', 'uruguay', 'guyana', 'suriname'],
  'Europe': ['united-kingdom', 'germany', 'france', 'italy', 'spain', 'portugal', 'netherlands', 'belgium', 'switzerland', 'austria', 'poland', 'czech-republic', 'hungary', 'romania', 'greece', 'sweden', 'norway', 'denmark', 'finland', 'ireland', 'scotland', 'wales', 'england'],
  'Asia': ['china', 'japan', 'south-korea', 'india', 'indonesia', 'thailand', 'vietnam', 'philippines', 'malaysia', 'singapore', 'taiwan', 'hong-kong', 'pakistan', 'bangladesh', 'sri-lanka', 'nepal', 'myanmar'],
  'Middle East': ['saudi-arabia', 'united-arab-emirates', 'israel', 'turkey', 'iran', 'iraq', 'egypt', 'jordan', 'lebanon', 'syria', 'qatar', 'kuwait', 'bahrain', 'oman', 'yemen', 'palestine'],
  'Africa': ['south-africa', 'nigeria', 'kenya', 'morocco', 'algeria', 'egypt', 'ethiopia', 'ghana', 'tanzania', 'uganda', 'senegal', 'ivory-coast', 'cameroon', 'zimbabwe', 'zambia'],
...
export const AllFlags: Story = {
  ...
  render: () => {
    ...
    const filteredFlags = useMemo(() => {
      ...
      return flagsIndex.flags.filter((flag: FlagData) => 
        flag.name.toLowerCase().includes(lower) ||
        flag.code.toLowerCase().includes(lower)
      );
    }, [search]);
