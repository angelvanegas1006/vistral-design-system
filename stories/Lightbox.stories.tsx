  ...
  render: () => {
    ...
    return (
      <div style={{ display: 'flex', flexDirection: 'column', gap: 16, alignItems: 'center' }}>
        ...
        <p style={{ fontSize: 13, color: '#71717a' }}>Use arrow keys to navigate, ESC to close</p>
        <Lightbox images={DEMO_IMAGES} open={open} onOpenChange={setOpen} />
      </div>
    )
  },
}
  ...
  render: () => {
    ...
    return (
      <div style={{ display: 'flex', flexDirection: 'column', gap: 16, alignItems: 'center' }}>
        ...
        <Lightbox images={DEMO_IMAGES} open={open} onOpenChange={setOpen} enableZoom />
      </div>
    )
  },
}
  ...
  render: () => {
    ...
    return (
      <>
        ...
        <Lightbox images={DEMO_IMAGES} open={open} onOpenChange={setOpen} showThumbnails={false} />
      </>
    )
  },
}
