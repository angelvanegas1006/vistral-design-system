...
import { forwardRef, useId, useState, createContext, useRef, useEffect, useCallback, useContext } from 'react';
import { Loader2, X, Minus, Check, Search, Filter, Plus, ChevronUp, ChevronDown, Upload, CheckCircle, AlertCircle, ChevronLeft, ChevronRight, Home, PanelLeftClose, TrendingUp, TrendingDown, MoreHorizontal, ChevronsLeft, ChevronsRight, WifiOff, FileQuestion, FolderOpen, Inbox, AlertTriangle, CheckCircle2, Info, Megaphone, User, Images, Calendar as Calendar$1, Star, Pipette, ExternalLink, Building, Heart, Bed, Bath, Maximize, FileText, File, Music, Film, Image, ArrowLeft, ZoomOut, ZoomIn, Download, Circle, Clock } from 'lucide-react';
    ...
    return /* @__PURE__ */ jsxs(
      "button",
      {
        ...
        children: [
          ...
          ) : LeftIcon ? /* @__PURE__ */ jsx(LeftIcon, { size: sizeTokens.iconSize }) : iconOnly && React2.isValidElement(children) ? (
          ...
          !iconOnly && children,
          !isLoading && RightIcon && !iconOnly && /* @__PURE__ */ jsx(RightIcon, { size: sizeTokens.iconSize })
        ]
      }
    );
  }
...
var Text = forwardRef(
  ({
    ...
    return /* @__PURE__ */ jsx(Element, { ref, style: textStyle, ...props, children });
  }
);
...
var Input = forwardRef(
  ({
    ...
    const [isFocused, setIsFocused] = React2.useState(false);
    const [isHovered, setIsHovered] = React2.useState(false);
    const [currentValue, setCurrentValue] = React2.useState(value || "");
    ...
    return /* @__PURE__ */ jsxs("div", { style: containerStyle, children: [
      label && /* @__PURE__ */ jsxs("div", { style: labelWrapperStyle, children: [
        /* @__PURE__ */ jsx("label", { htmlFor: id, style: labelStyle, children: label }),
        optional && /* @__PURE__ */ jsx("span", { style: optionalStyle, children: "Optional" })
      ] }),
      /* @__PURE__ */ jsxs(
        "div",
        {
          ...
          children: [
            LeftIcon && /* @__PURE__ */ jsx("div", { style: iconStyle("left"), children: /* @__PURE__ */ jsx(LeftIcon, { size: sizeTokens.iconSize }) }),
            /* @__PURE__ */ jsx(
              "input",
              {
                ref,
            ...
            showCharacterCounter && /* @__PURE__ */ jsxs("div", { style: counterStyle, children: [
              characterCount,
              "/",
              maxLength
            ] }),
            RightIcon && !showCharacterCounter && /* @__PURE__ */ jsx("div", { style: iconStyle("right"), children: /* @__PURE__ */ jsx(
              RightIcon,
              {
                size: sizeTokens.iconSize,
                style: {
                  animation: RightIcon === Loader2 ? "spin 1s linear infinite" : void 0
                }
              }
            ) })
          ]
      ...
      (helperText || errorMessage || suffix) && /* @__PURE__ */ jsxs("div", { style: helperWrapperStyle, children: [
        /* @__PURE__ */ jsx("p", { id: `${id}-helper`, style: helperStyle, children: error ? errorMessage : helperText }),
        suffix && /* @__PURE__ */ jsx("span", { style: suffixStyle, children: suffix })
      ] })
    ] });
  }
);
...
var Textarea = forwardRef(
  ({
    ...
    return /* @__PURE__ */ jsxs("div", { style: containerStyle, children: [
      label && /* @__PURE__ */ jsx("label", { htmlFor: id, style: labelStyle, children: label }),
      /* @__PURE__ */ jsx(
        "textarea",
        {
          ref: textareaRef,
      ...
      (helperText || errorMessage || showCharacterCounter) && /* @__PURE__ */ jsxs("div", { style: helperWrapperStyle, children: [
        /* @__PURE__ */ jsx("p", { id: `${id}-helper`, style: helperStyle, children: error ? errorMessage : helperText }),
        showCharacterCounter && /* @__PURE__ */ jsxs("span", { style: counterStyle, children: [
          characterCount,
          "/",
          maxLength,
          " characters"
...
var Badge = forwardRef(
  ({ variant = "default", size = "md", style, children, ...props }, ref) => {
    ...
    return /* @__PURE__ */ jsx("span", { ref, style: badgeStyle, ...props, children });
  }
);
Badge.displayName = "Badge";
var DotBadge = forwardRef(
  ({
    variant = "error",
    size = "md",
    count,
    ...
    return /* @__PURE__ */ jsx("span", { ref, style: dotStyle, ...props, children: displayCount });
  }
);
DotBadge.displayName = "DotBadge";
var BadgeContainer = forwardRef(
  ({ style, children, ...props }, ref) => {
    ...
    return /* @__PURE__ */ jsx("div", { ref, style: containerStyle, ...props, children });
  }
);
  ...
  ({
    ...
    return /* @__PURE__ */ jsxs(
      "span",
      {
        ...
        ...props,
        children: [
          Icon2 && /* @__PURE__ */ jsx(Icon2, { size: sizeTokens.iconSize }),
          ...
          closable && /* @__PURE__ */ jsx(
            "button",
            {
              ...
              children: /* @__PURE__ */ jsx(X, { size: sizeTokens.iconSize - 2 })
            }
          )
        ]
      }
  ...
  ({
    ...
    return /* @__PURE__ */ jsxs(
      "label",
      {
        ...
        htmlFor: id,
        children: [
          /* @__PURE__ */ jsxs("span", { style: checkboxWrapperStyle, children: [
            /* @__PURE__ */ jsx(
              "input",
              {
                ref,
            ...
            /* @__PURE__ */ jsx("span", { style: visualBoxStyle, children: showIcon && /* @__PURE__ */ jsx(
              IconComponent,
              {
          ...
          (label || description) && /* @__PURE__ */ jsxs("span", { style: labelContainerStyle, children: [
            label && /* @__PURE__ */ jsx("span", { style: labelStyle, children: label }),
            description && /* @__PURE__ */ jsx("span", { style: descriptionStyle, children: description })
          ] })
        ]
      }
    );
...
var CheckboxGroup = forwardRef(
  ({ label, error, orientation = "vertical", style, children, ...props }, ref) => {
    ...
    return /* @__PURE__ */ jsxs("div", { ref, role: "group", ...props, children: [
      label && /* @__PURE__ */ jsx("div", { style: { marginBottom: 12, fontSize: 14, fontWeight: 600, color: "#18181b" }, children: label }),
      /* @__PURE__ */ jsx("div", { style: groupStyle, children }),
...
var Switch = forwardRef(
  ({
    ...
    const [internalChecked, setInternalChecked] = React2.useState(defaultChecked);
    const generatedId = useId();
    const id = providedId || generatedId;
    ...
    const switchElement = /* @__PURE__ */ jsxs("span", { style: switchWrapperStyle, children: [
      /* @__PURE__ */ jsx(
        "input",
        {
          ref,
      ...
      /* @__PURE__ */ jsx("span", { style: trackStyle, "aria-hidden": "true", children: /* @__PURE__ */ jsx("span", { style: thumbStyle }) })
    ] });
    const labelElement = label || description ? /* @__PURE__ */ jsxs("span", { style: labelContainerStyle, children: [
      label && /* @__PURE__ */ jsx("span", { style: labelStyle, children: label }),
      description && /* @__PURE__ */ jsx("span", { style: descriptionStyle, children: description })
    ] }) : null;
    return /* @__PURE__ */ jsxs("label", { htmlFor: id, style: containerStyle, children: [
      switchElement,
      labelElement
    ] });
  }
...
var RadioGroup = forwardRef(
  ({
    ...
    return /* @__PURE__ */ jsx(RadioGroupContext.Provider, { value: { name, value, onValueChange: handleValueChange, disabled }, children: /* @__PURE__ */ jsx("div", { ref, role: "radiogroup", style: groupStyle, ...props, children }) });
  }
);
  ...
  ({
    ...
    return /* @__PURE__ */ jsxs(
      "label",
      {
        ...
        onMouseLeave: () => setIsHovered(false),
        children: [
          /* @__PURE__ */ jsxs("span", { style: radioWrapperStyle, children: [
            /* @__PURE__ */ jsx(
              "input",
              {
                ref,
            ...
            /* @__PURE__ */ jsx("span", { style: outerStyle, children: /* @__PURE__ */ jsx("span", { style: innerStyle }) })
          ] }),
          (label || description) && /* @__PURE__ */ jsxs("span", { style: labelContainerStyle, children: [
            label && /* @__PURE__ */ jsx("span", { style: labelStyle, children: label }),
            description && /* @__PURE__ */ jsx("span", { style: descriptionStyle, children: description })
...
var SearchInput = forwardRef(
  ({
    ...
    return /* @__PURE__ */ jsxs("div", { style: wrapperStyle, role: "search", children: [
      label && /* @__PURE__ */ jsx(
        "label",
        {
          htmlFor: inputId,
      ...
      /* @__PURE__ */ jsxs("div", { style: containerStyle, children: [
        /* @__PURE__ */ jsx("span", { style: iconContainerStyle, children: /* @__PURE__ */ jsx(Search, { size: iconSize }) }),
        /* @__PURE__ */ jsx(
          "input",
          {
            ref: inputRef || ref,
        ...
        showFilter && /* @__PURE__ */ jsxs(
          "button",
          {
            ...
            children: [
              FilterIcon ? /* @__PURE__ */ jsx(FilterIcon, { size: 16 }) : /* @__PURE__ */ jsx(Filter, { size: 16 }),
              filterCount !== void 0 && filterCount > 0 && /* @__PURE__ */ jsx("span", { style: filterBadgeStyle, children: filterCount })
            ]
          }
        )
      ] }),
...
var NumberInput = forwardRef(
  ({
    ...
    return /* @__PURE__ */ jsxs("div", { style: wrapperStyle, children: [
      label && /* @__PURE__ */ jsx("label", { style: { display: "block", marginBottom: 6, fontSize: 14, fontWeight: 500, color: "#18181b" }, children: label }),
      /* @__PURE__ */ jsxs("div", { style: containerStyle, children: [
      ...
      helperText && /* @__PURE__ */ jsx("p", { style: { margin: "6px 0 0", fontSize: 12, color: error ? "#dc2626" : "#71717a" }, children: helperText })
    ] });
  }
);
  ...
  ({
    ...
    return /* @__PURE__ */ jsxs("div", { ref, style: containerStyle, ...props, children: [
      /* @__PURE__ */ jsxs("div", { style: rowStyle, children: [
        label && /* @__PURE__ */ jsx("label", { htmlFor: generatedId, style: labelStyle, children: label }),
        showDivider && label && /* @__PURE__ */ jsx("div", { style: dividerStyle }),
...
var PhoneInput = forwardRef(
  ({
    ...
    const filteredCountries = React2.useMemo(() => {
    ...
    return /* @__PURE__ */ jsxs("div", { style: wrapperStyle, children: [
      ...
      /* @__PURE__ */ jsxs("div", { ref: containerRef, style: containerStyle, children: [
        /* @__PURE__ */ jsxs("div", { style: { position: "relative" }, children: [
          /* @__PURE__ */ jsxs(
            "button",
            {
              ...
              children: [
                /* @__PURE__ */ jsx("span", { style: { fontSize: 18 }, children: selectedCountry.flag }),
                /* @__PURE__ */ jsx("span", { style: { color: "#18181b", fontWeight: 500 }, children: selectedCountry.dialCode }),
                isOpen ? /* @__PURE__ */ jsx(ChevronUp, { size: 16, style: { color: "#71717a" } }) : /* @__PURE__ */ jsx(ChevronDown, { size: 16, style: { color: "#71717a" } })
              ]
            }
          ),
          isOpen && /* @__PURE__ */ jsxs(
            "div",
            {
              ...
              style: dropdownStyle,
              children: [
                /* @__PURE__ */ jsxs("div", { style: searchStyle, children: [
                  /* @__PURE__ */ jsx(Search, { size: 16, style: { color: "#71717a" } }),
                  /* @__PURE__ */ jsx(
                    "input",
                    {
                      ref: searchInputRef,
                ...
                /* @__PURE__ */ jsxs("div", { style: optionsContainerStyle, children: [
                  filteredCountries.map((c) => {
                    ...
                    return /* @__PURE__ */ jsxs(
                      "div",
                      {
                        ...
                        children: [
                          /* @__PURE__ */ jsx("span", { style: { fontSize: 18 }, children: c.flag }),
                          /* @__PURE__ */ jsx("span", { style: { flex: 1, color: "#18181b" }, children: c.name }),
                          /* @__PURE__ */ jsx("span", { style: { color: "#71717a", marginRight: 8 }, children: c.dialCode }),
                          isSelected && /* @__PURE__ */ jsx(Check, { size: 16, style: { color: "#2050f6" } })
                        ]
                      },
                      c.code
                    );
                  }),
                  filteredCountries.length === 0 && /* @__PURE__ */ jsx("div", { style: { padding: PHONE_INPUT_TOKENS.dropdown.optionPadding, color: "#71717a", fontSize: 14 }, children: "No countries found" })
                ] })
              ]
            }
          )
        ] }),
        /* @__PURE__ */ jsx("div", { style: inputContainerStyle, children: /* @__PURE__ */ jsx(
          "input",
          {
            ref,
...
var PinCode = forwardRef(
  ({
    ...
    return /* @__PURE__ */ jsxs("div", { ref, style: containerStyle, ...props, children: [
      label && /* @__PURE__ */ jsx("label", { style: {
        fontSize: 14,
        fontWeight: 500,
        color: "#18181b"
      }, children: label }),
      /* @__PURE__ */ jsx("div", { style: inputsContainerStyle, children: Array.from({ length }).map((_, index) => /* @__PURE__ */ jsx(
        PinCell,
        {
          ref: (el) => {
      ...
      helperText && /* @__PURE__ */ jsx("p", { style: {
        margin: 0,
        fontSize: 12,
...
var TagInput = forwardRef(
  ({
    ...
    return /* @__PURE__ */ jsxs("div", { ref, style: wrapperStyle, ...props, children: [
      label && /* @__PURE__ */ jsx("label", { style: { display: "block", marginBottom: 6, fontSize: 14, fontWeight: 500, color: "#18181b" }, children: label }),
      /* @__PURE__ */ jsxs(
        "div",
        {
          ...
          children: [
            tags.map((tag, index) => /* @__PURE__ */ jsxs("span", { style: tagStyle, children: [
              tag,
...
var FileUpload = forwardRef(
  ({
    ...
    return /* @__PURE__ */ jsxs("div", { ref, style: containerStyle, ...props, children: [
      label && /* @__PURE__ */ jsx("label", { style: { display: "block", marginBottom: 8, fontSize: 14, fontWeight: 500, color: "#18181b" }, children: label }),
      /* @__PURE__ */ jsxs(
        "div",
        {
          style: dropzoneStyle,
          ...
          children: [
            ...
            /* @__PURE__ */ jsx(Upload, { size: 32, style: { color: "#71717a", marginBottom: 12 } }),
            /* @__PURE__ */ jsx("p", { style: { margin: "0 0 4px", fontSize: 14, fontWeight: 500, color: "#18181b" }, children: isDragActive ? "Drop files here" : "Click to upload or drag and drop" }),
            /* @__PURE__ */ jsxs("p", { style: { margin: 0, fontSize: 12, color: "#71717a" }, children: [
      ...
      helperText && !error && /* @__PURE__ */ jsx("p", { style: { margin: "8px 0 0", fontSize: 12, color: "#71717a" }, children: helperText }),
      error && /* @__PURE__ */ jsx("p", { style: { margin: "8px 0 0", fontSize: 12, color: "#dc2626" }, children: error }),
      files.length > 0 && /* @__PURE__ */ jsx("div", { style: fileListStyle, children: files.map((uploadFile) => {
        const FileIcon = getFileIcon(uploadFile.file);
        return /* @__PURE__ */ jsxs("div", { style: fileItemStyle, children: [
          /* @__PURE__ */ jsx(FileIcon, { size: 20, style: { color: "#71717a", flexShrink: 0 } }),
          /* @__PURE__ */ jsxs("div", { style: { flex: 1, minWidth: 0 }, children: [
            /* @__PURE__ */ jsx("p", { style: { margin: 0, fontSize: 13, fontWeight: 500, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }, children: uploadFile.file.name }),
            /* @__PURE__ */ jsx("p", { style: { margin: "2px 0 0", fontSize: 11, color: "#71717a" }, children: formatFileSize(uploadFile.file.size) }),
            uploadFile.status === "uploading" && /* @__PURE__ */ jsx("div", { style: { marginTop: 6, height: FILE_UPLOAD_TOKENS.progress.height, backgroundColor: FILE_UPLOAD_TOKENS.progress.bg, borderRadius: FILE_UPLOAD_TOKENS.progress.radius }, children: /* @__PURE__ */ jsx("div", { style: {
              height: "100%",
          ...
          uploadFile.status === "success" && /* @__PURE__ */ jsx(CheckCircle, { size: 16, style: { color: "#16a34a" } }),
          uploadFile.status === "error" && /* @__PURE__ */ jsx(AlertCircle, { size: 16, style: { color: "#dc2626" } }),
          /* @__PURE__ */ jsx(
            "button",
            {
              type: "button",
...
var Uploader = forwardRef(
  ({
    ...
    const inputRef = useRef(null);
    const progressTimersRef = useRef(/* @__PURE__ */ new Map());
    useEffect(() => {
    ...
    const renderDropzone = () => {
      ...
      return /* @__PURE__ */ jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsx(Upload, { size: UPLOADER_TOKENS.icon.size, style: iconStyle }),
            /* @__PURE__ */ jsx(
              "p",
              {
                style: {
      ...
      return /* @__PURE__ */ jsxs(
        "button",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxs("div", { style: { display: "flex", flexDirection: "column", alignItems: "flex-start", gap: 2 }, children: [
    ...
    const renderFileList = () => {
      ...
      return /* @__PURE__ */ jsx("div", { style: fileListStyle, children: files.map((uploadedFile) => {
        const FileIcon = getFileIcon(uploadedFile.file);
        const isUploading = uploadedFile.progress !== void 0 && uploadedFile.progress < 100;
        return /* @__PURE__ */ jsxs("div", { style: fileItemStyle, children: [
          /* @__PURE__ */ jsxs("div", { style: thumbnailStyle, children: [
            ...
            ) : /* @__PURE__ */ jsx(FileIcon, { size: 20, color: "#71717a" }),
          ...
          isUploading && /* @__PURE__ */ jsx("div", { style: { display: "flex", alignItems: "center", gap: 8 }, children: /* @__PURE__ */ jsx(
            Loader2,
            {
              size: 16,
              color: "#71717a",
    ...
    return /* @__PURE__ */ jsxs("div", { ref, style: containerStyle, ...props, children: [
      label && /* @__PURE__ */ jsx("label", { style: labelStyle, children: label }),
      ...
      errorMessage && /* @__PURE__ */ jsx("p", { style: errorStyle, children: errorMessage }),
      helperText && !errorMessage && /* @__PURE__ */ jsx("p", { id: "uploader-helper", style: helperStyle, children: helperText }),
      renderFileList()
    ] });
  }
);
...
var SelectTrigger = React2.forwardRef(({ className, size = "md", error = false, label, helperText, fullWidth, ...props }, ref) => {
  ...
  return /* @__PURE__ */ jsxs("div", { style: { width: fullWidth ? "100%" : "auto" }, children: [
    label && /* @__PURE__ */ jsx(
      "label",
      {
        htmlFor: triggerId,
    ...
    /* @__PURE__ */ jsxs(
      SelectPrimitive.Trigger,
      {
        ...
        children: [
          props.children,
          /* @__PURE__ */ jsx(SelectPrimitive.Icon, { asChild: true, children: /* @__PURE__ */ jsx(ChevronDown, { className: "h-4 w-4 opacity-50 transition-transform duration-200" }) })
        ]
      }
    ),
    helperText && /* @__PURE__ */ jsx(
...
var SelectItem = React2.forwardRef(({ className, children, ...props }, ref) => {
  ...
  return /* @__PURE__ */ jsxs(
    SelectPrimitive.Item,
    {
      ...
      ...props,
      children: [
        /* @__PURE__ */ jsx("span", { className: "absolute left-2 flex h-4 w-4 items-center justify-center", children: /* @__PURE__ */ jsx(SelectPrimitive.ItemIndicator, { children: /* @__PURE__ */ jsx(Check, { className: "h-4 w-4" }) }) }),
  ...
  ({
    ...
    return /* @__PURE__ */ jsxs("div", { ref: containerRef, style: containerStyle, children: [
      /* @__PURE__ */ jsxs("div", { style: inputContainerStyle, children: [
        /* @__PURE__ */ jsx(Search, { size: 16, style: iconStyle }),
        /* @__PURE__ */ jsx(
          "input",
          {
            ref: inputRef,
        ...
        clearable && inputValue && !disabled && /* @__PURE__ */ jsx("button", { type: "button", style: clearStyle, onClick: handleClear, children: /* @__PURE__ */ jsx(X, { size: 16 }) })
      ] }),
      isOpen && /* @__PURE__ */ jsx("div", { style: dropdownStyle, role: "listbox", children: loading ? /* @__PURE__ */ jsx("div", { style: emptyStyle, children: "Loading..." }) : filteredOptions.length === 0 ? /* @__PURE__ */ jsx("div", { style: emptyStyle, children: emptyMessage }) : filteredOptions.map((option, index) => /* @__PURE__ */ jsxs(
        "div",
        {
          role: "option",
          ...
          children: [
            ...
            option.value === value && /* @__PURE__ */ jsx(Check, { size: 16, style: { color: "#2050f6" } })
          ]
        },
        option.value
      )) })
...
var Combobox = forwardRef(
  ({
    ...
    const highlightText = (text, query) => {
      ...
      return parts.map(
        (part, i) => part.toLowerCase() === query.toLowerCase() ? /* @__PURE__ */ jsx("mark", { style: { backgroundColor: "transparent", color: "#2050f6", fontWeight: 600 }, children: part }, i) : part
      );
    };
    const containerStyle = {
      position: "relative",
    ...
    return /* @__PURE__ */ jsxs("div", { ref: containerRef, style: containerStyle, ...props, children: [
      label && /* @__PURE__ */ jsx("label", { style: {
        display: "block",
        marginBottom: 6,
        fontSize: 14,
        ...
        "div",
        {
          ...
          children: [
            multiple && selectedValues.map((val) => {
              ...
              return opt ? /* @__PURE__ */ jsxs("span", { style: tagStyle, children: [
                opt.label,
                /* @__PURE__ */ jsx(
                  "button",
                  {
            ...
            !isOpen && /* @__PURE__ */ jsx("span", { style: inputStyle, children: multiple ? selectedValues.length === 0 ? placeholder : "" : getDisplayValue() || placeholder }),
            showCount && selectedValues.length > 0 && /* @__PURE__ */ jsx("span", { style: countBadgeStyle, children: selectedValues.length }),
            /* @__PURE__ */ jsxs("div", { style: { display: "flex", alignItems: "center", gap: 4, marginLeft: "auto", flexShrink: 0 }, children: [
              clearable && selectedValues.length > 0 && !isOpen && /* @__PURE__ */ jsx(
                "button",
                {
                  type: "button",
                  onClick: handleClear,
      ...
      (error || description) && /* @__PURE__ */ jsx("div", { style: {
      ...
      isOpen && /* @__PURE__ */ jsxs("div", { style: dropdownStyle, role: "listbox", children: [
        searchable && /* @__PURE__ */ jsx("div", { style: searchContainerStyle, children: /* @__PURE__ */ jsxs("div", { style: { position: "relative" }, children: [
          /* @__PURE__ */ jsx(
            Search,
            {
              size: 16,
        ...
        /* @__PURE__ */ jsx("div", { style: optionsContainerStyle, children: filteredOptions.length === 0 ? /* @__PURE__ */ jsx("div", { style: {
          padding: 12,
          textAlign: "center",
          fontSize: 13,
          color: COMBOBOX_TOKENS.option.fgMuted,
          fontFamily: "'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif"
        }, children: "No element found" }) : filteredOptions.map((option, index) => /* @__PURE__ */ jsxs(
          "div",
          {
            role: "option",
            ...
            onMouseEnter: () => setHighlightedIndex(index),
            children: [
              /* @__PURE__ */ jsx("span", { children: highlightText(option.label, search) }),
              selectedValues.includes(option.value) && /* @__PURE__ */ jsx(Check, { size: 16, style: { color: "#2050f6", flexShrink: 0 } })
            ]
          },
          option.value
        )) })
...
var DialogContent = React2.forwardRef(({ className, children, size = "md", variant = "desktop", ...props }, ref) => {
  ...
  ({ className, showBack, onBack, children, ...props }, ref) => {
    ...
    return /* @__PURE__ */ jsxs(
      "div",
      {
        ...
        ...props,
        children: [
          showBack && /* @__PURE__ */ jsx(DialogPrimitive.Close, { asChild: true, children: /* @__PURE__ */ jsxs(
            "button",
            {
              onClick: handleBack,
...
var DialogBody = React2.forwardRef(
...
var DialogFooter = React2.forwardRef(
  ({ className, stacked, style, ...props }, ref) => /* @__PURE__ */ jsx(
    "div",
    {
      ref,
      className: cn2(
...
var PopoverClose = ({ asChild, children, onClick, ...props }) => {
  ...
  if (asChild && React2.isValidElement(children)) {
    return React2.cloneElement(children, { onClick: handleClick });
  }
...
var Sheet = ({
  ...
  return /* @__PURE__ */ jsx(SheetContext.Provider, { value: { open, setOpen }, children });
};
    ...
    return /* @__PURE__ */ jsxs(Fragment, { children: [
      ...
      /* @__PURE__ */ jsxs(
        "div",
        {
          ...
          ...props,
          children: [
            showClose && /* @__PURE__ */ jsx("button", { type: "button", style: closeStyle, onClick: () => setOpen(false), children: /* @__PURE__ */ jsx(X, { size: 20 }) }),
            children
          ]
        }
      )
...
var SheetHeader = forwardRef(
  ({ style, children, ...props }, ref) => {
    ...
    return /* @__PURE__ */ jsx("div", { ref, style: headerStyle, ...props, children });
  }
);
...
var SheetTitle = forwardRef(
  ({ style, children, ...props }, ref) => {
    ...
    return /* @__PURE__ */ jsx("h2", { ref, style: titleStyle, ...props, children });
  }
);
...
var SheetDescription = forwardRef(
  ({ style, children, ...props }, ref) => {
    ...
    return /* @__PURE__ */ jsx("p", { ref, style: descStyle, ...props, children });
  }
);
SheetDescription.displayName = "SheetDescription";
var SheetBody = forwardRef(
  ({ style, children, ...props }, ref) => {
    const bodyStyle = {
      flex: 1,
    ...
    return /* @__PURE__ */ jsx("div", { ref, style: bodyStyle, ...props, children });
  }
);
...
var SheetFooter = forwardRef(
  ({ style, children, ...props }, ref) => {
    ...
    return /* @__PURE__ */ jsx("div", { ref, style: footerStyle, ...props, children });
  }
);
...
var Tooltip = ({
  ...
  return /* @__PURE__ */ jsx(TooltipContext.Provider, { value: { open, setOpen, triggerRef }, children });
};
...
var TooltipContent = forwardRef(
  ({
    ...
    return /* @__PURE__ */ jsx("div", { ref: ref || contentRef, role: "tooltip", style: contentStyle, ...props, children });
  }
);
...
var DropdownMenu = ({
  ...
  return /* @__PURE__ */ jsx(DropdownContext.Provider, { value: { open, setOpen, triggerRef }, children });
};
    ...
    return /* @__PURE__ */ jsxs(
      "div",
      {
        ...
        children: [
          ...
          shortcut && /* @__PURE__ */ jsx("span", { style: shortcutStyle, children: shortcut })
        ]
      }
    );
  }
...
var DropdownMenuSeparator = forwardRef(
  ({ style, ...props }, ref) => {
    ...
    return /* @__PURE__ */ jsx("hr", { ref, style: sepStyle, ...props });
  }
);
...
var DropdownMenuLabel = forwardRef(
  ({ style, children, ...props }, ref) => {
    ...
    return /* @__PURE__ */ jsx("div", { ref, style: labelStyle, ...props, children });
  }
);
  ...
  ({ checked = false, onCheckedChange, onClick, children, ...props }, ref) => {
    ...
    return /* @__PURE__ */ jsxs(
      "div",
      {
        ...
        ...props,
        children: [
          /* @__PURE__ */ jsx("span", { style: checkboxStyle, children: checked && /* @__PURE__ */ jsx(Check, { size: 12, color: "#ffffff", strokeWidth: 3 }) }),
          /* @__PURE__ */ jsx("span", { style: { flex: 1 }, children })
        ]
      }
    );
...
var ContextMenu = ({ children, onOpenChange }) => {
  ...
  return /* @__PURE__ */ jsx(ContextMenuContext.Provider, { value: { position, setPosition, closeMenu }, children });
};
...
var ContextMenuTrigger = forwardRef(
  ({ asChild, children, ...props }, ref) => {
    ...
    return /* @__PURE__ */ jsx("div", { ref, onContextMenu: handleContextMenu, ...props, children });
  }
);
...
var ContextMenuContent = forwardRef(
  ({ style, children, ...props }, ref) => {
    ...
    return /* @__PURE__ */ jsx("div", { ref: ref || menuRef, role: "menu", style: menuStyle, ...props, children });
  }
);
...
var ContextMenuLabel = forwardRef(
  ({ style, children, ...props }, ref) => {
    ...
    return /* @__PURE__ */ jsx("div", { ref, role: "presentation", style: labelStyle, ...props, children });
  }
);
  ...
  ({ icon: Icon2, rightIcon: RightIcon, shortcut, disabled, destructive, hasSubmenu, style, onClick, children, ...props }, ref) => {
    ...
    return /* @__PURE__ */ jsxs(
      "div",
      {
        ...
        ...props,
        children: [
          Icon2 && /* @__PURE__ */ jsx(Icon2, { size: CONTEXT_MENU_TOKENS.item.iconSize, style: { flexShrink: 0 } }),
          /* @__PURE__ */ jsx("span", { style: { flex: 1 }, children }),
          shortcut && /* @__PURE__ */ jsx("span", { style: { fontSize: 11, color: CONTEXT_MENU_TOKENS.item.fgMuted, marginLeft: "auto" }, children: shortcut }),
          hasSubmenu && !shortcut && /* @__PURE__ */ jsx(ChevronRight, { size: CONTEXT_MENU_TOKENS.item.iconSize, style: { color: CONTEXT_MENU_TOKENS.item.fgMuted, flexShrink: 0 } }),
          RightIcon && !hasSubmenu && !shortcut && /* @__PURE__ */ jsx(RightIcon, { size: CONTEXT_MENU_TOKENS.item.iconSize, style: { flexShrink: 0 } })
        ]
      }
    );
  }
...
var ContextMenuCheckboxItem = forwardRef(
  ({ checked, onCheckedChange, onClick, children, ...props }, ref) => {
    const handleClick = (e) => {
      onCheckedChange?.(!checked);
      onClick?.(e);
    };
    return /* @__PURE__ */ jsxs(ContextMenuItem, { ref, onClick: handleClick, ...props, children: [
      /* @__PURE__ */ jsx("span", { style: { width: 16, display: "flex", justifyContent: "center", alignItems: "center" }, children: checked && /* @__PURE__ */ jsx(Check, { size: 12, style: { color: "#2050f6" } }) }),
      children
    ] });
  }
);
ContextMenuCheckboxItem.displayName = "ContextMenuCheckboxItem";
var ContextMenuRadioItem = forwardRef(
  ({ checked, onCheckedChange, onClick, children, ...props }, ref) => {
    const handleClick = (e) => {
      onCheckedChange?.(!checked);
      onClick?.(e);
    ...
    return /* @__PURE__ */ jsxs(ContextMenuItem, { ref, onClick: handleClick, ...props, children: [
      /* @__PURE__ */ jsx("span", { style: radioStyle, children: checked && /* @__PURE__ */ jsx("span", { style: innerDotStyle }) }),
      children
    ] });
  }
);
...
var Tabs = forwardRef(
  ({
    ...
    return /* @__PURE__ */ jsx(TabsContext.Provider, { value: { value, onValueChange: handleValueChange, level }, children: /* @__PURE__ */ jsx("div", { ref, style, ...props, children }) });
  }
);
...
var TabsList = forwardRef(
  ({ variant, style, children, ...props }, ref) => {
    ...
    return /* @__PURE__ */ jsx("div", { ref, role: "tablist", style: listStyle, ...props, children });
  }
);
    ...
    return /* @__PURE__ */ jsxs(
      "button",
      {
        ...
        children: [
          Icon2 && /* @__PURE__ */ jsx(Icon2, { size: 16 }),
          /* @__PURE__ */ jsx("span", { children }),
          tag && /* @__PURE__ */ jsx("span", { style: tagStyle, children: tag }),
          badge && /* @__PURE__ */ jsx("span", { style: badgeStyle, children: typeof badge === "number" ? badge : "" }),
          effectiveLevel === 1 && /* @__PURE__ */ jsx("span", { style: indicatorStyle })
        ]
      }
    );
  }
...
var Accordion = forwardRef(
  ({
    ...
    return /* @__PURE__ */ jsx(AccordionContext.Provider, { value: { expandedItems, toggleItem, type }, children: /* @__PURE__ */ jsx("div", { ref, style: containerStyle, ...props, children }) });
  }
);
...
var AccordionItem = forwardRef(
  ({ value, disabled = false, style, children, ...props }, ref) => {
    ...
    return /* @__PURE__ */ jsx(AccordionItemContext.Provider, { value: { value, isExpanded, triggerId, contentId }, children: /* @__PURE__ */ jsx(
      "div",
      {
        ref,
  ...
  ({ showIcon = true, style, children, ...props }, ref) => {
    ...
    return /* @__PURE__ */ jsxs(
      "button",
      {
        ...
        children: [
          /* @__PURE__ */ jsx("span", { style: { flex: 1 }, children }),
          showIcon && /* @__PURE__ */ jsx(ChevronDown, { size: 16, style: iconStyle })
        ]
      }
    );
  }
...
var Breadcrumb = forwardRef(
  ({ separator, style, children, ...props }, ref) => {
    ...
    const itemsWithSeparators = childArray.flatMap((child, index) => {
      ...
      return [
        child,
        /* @__PURE__ */ jsx(BreadcrumbSeparator, { children: separator }, `sep-${index}`)
      ];
    });
    return /* @__PURE__ */ jsx("nav", { ref, "aria-label": "Breadcrumb", style: navStyle, ...props, children: /* @__PURE__ */ jsx("ol", { style: listStyle, children: itemsWithSeparators }) });
  }
);
...
var BreadcrumbItem = forwardRef(
  ({ style, children, ...props }, ref) => {
    ...
    return /* @__PURE__ */ jsx("li", { ref, style: itemStyle, ...props, children });
  }
);
...
var BreadcrumbSeparator = forwardRef(
  ({ style, children, ...props }, ref) => {
    ...
    return /* @__PURE__ */ jsx("span", { ref, role: "presentation", "aria-hidden": "true", style: sepStyle, ...props, children: children || /* @__PURE__ */ jsx(ChevronRight, { size: BREADCRUMB_TOKENS.separator.size }) });
  }
);
BreadcrumbSeparator.displayName = "BreadcrumbSeparator";
var BreadcrumbHome = forwardRef(
  ({ iconOnly = false, label = "Home", ...props }, ref) => {
    return /* @__PURE__ */ jsx(BreadcrumbLink, { ref, ...props, children: /* @__PURE__ */ jsxs("span", { style: { display: "flex", alignItems: "center", gap: 4 }, children: [
...
var Navbar = forwardRef(
  ({ fixed = false, bordered = true, transparent = false, style, children, ...props }, ref) => {
    ...
    return /* @__PURE__ */ jsx("nav", { ref, style: navStyle, ...props, children });
  }
);
...
var NavbarBrand = forwardRef(
  ({ logo, name, href, style, children, ...props }, ref) => {
    ...
    const content = /* @__PURE__ */ jsxs(Fragment, { children: [
      logo,
      name && /* @__PURE__ */ jsx("span", { style: nameStyle, children: name }),
      children
    ] });
    if (href) {
...
var NavbarTitle = forwardRef(
  ({ style, children, ...props }, ref) => {
    ...
    return /* @__PURE__ */ jsx("h1", { ref, style: titleStyle, ...props, children });
  }
);
...
var NavbarActions = forwardRef(
  ({ align = "right", style, children, ...props }, ref) => {
    ...
    return /* @__PURE__ */ jsx("div", { ref, style: actionsStyle, ...props, children });
  }
);
  ...
  ({ icon: Icon2, badge, style, children, ...props }, ref) => {
    ...
    return /* @__PURE__ */ jsxs(
      "button",
      {
        ...
        ...props,
        children: [
          Icon2 ? /* @__PURE__ */ jsx(Icon2, { size: 20 }) : children,
          badge && /* @__PURE__ */ jsx("span", { style: badgeStyle })
        ]
      }
    );
  }
...
var NavbarDivider = forwardRef(
  ({ style, ...props }, ref) => {
    ...
    return /* @__PURE__ */ jsx("div", { ref, style: dividerStyle, ...props });
  }
);
NavbarDivider.displayName = "NavbarDivider";
var NavbarToolsButton = forwardRef(
  ({ style, children, ...props }, ref) => {
    const [isHovered, setIsHovered] = React2.useState(false);
    const buttonStyle = {
      display: "flex",
...
var NavbarSecondaryButton = forwardRef(
  ({ style, children, ...props }, ref) => {
    const [isHovered, setIsHovered] = React2.useState(false);
    const buttonStyle = {
      display: "flex",
...
var NavbarPrimaryButton = forwardRef(
  ({ style, children, ...props }, ref) => {
    const [isHovered, setIsHovered] = React2.useState(false);
    const buttonStyle = {
      display: "flex",
...
var NavbarLeft = forwardRef(
  ({ style, children, ...props }, ref) => {
    ...
    return /* @__PURE__ */ jsx("div", { ref, style: leftStyle, ...props, children });
  }
);
...
var BottomNav = forwardRef(
  ({
    ...
    return /* @__PURE__ */ jsx(BottomNavContext.Provider, { value: { value, onValueChange: handleValueChange, showLabels }, children: /* @__PURE__ */ jsx("nav", { ref, role: "navigation", style: navStyle, ...props, children }) });
  }
);
...
var BottomNavSearch = forwardRef(
  ({ icon: Icon2, onPress, style, ...props }, ref) => {
    ...
    const SearchIcon = () => /* @__PURE__ */ jsxs("svg", { width: "24", height: "24", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", children: [
    ...
    return /* @__PURE__ */ jsx(
      "button",
      {
        ...
        ...props,
        children: Icon2 ? /* @__PURE__ */ jsx(Icon2, { size: 24 }) : /* @__PURE__ */ jsx(SearchIcon, {})
      }
    );
  }
);
...
var SideNavContext = createContext(null);
function useSideNav() {
...
var SideNav = forwardRef(
  ({
    ...
    return /* @__PURE__ */ jsx(SideNavContext.Provider, { value: { collapsed, activeItem, setActiveItem }, children: /* @__PURE__ */ jsx("nav", { ref, style: navStyle, ...props, children }) });
  }
);
SideNav.displayName = "SideNav";
var SideNavHeader = forwardRef(
  ({ logo, title, subtitle, showCollapseButton = true, onCollapse, style, children, ...props }, ref) => {
    ...
    return /* @__PURE__ */ jsxs("div", { ref, style: headerStyle, ...props, children: [
      /* @__PURE__ */ jsxs("div", { style: logoContainerStyle, children: [
        logo,
        (title || subtitle) && /* @__PURE__ */ jsxs("div", { style: titleContainerStyle, children: [
          title && /* @__PURE__ */ jsx("span", { style: titleStyle, children: title }),
          subtitle && /* @__PURE__ */ jsx("span", { style: subtitleStyle, children: subtitle })
        ] })
      ] }),
      showCollapseButton && !collapsed && /* @__PURE__ */ jsx("button", { type: "button", style: collapseButtonStyle, onClick: onCollapse, children: /* @__PURE__ */ jsx(PanelLeftClose, { size: 18 }) }),
      children
    ] });
  }
);
SideNavHeader.displayName = "SideNavHeader";
var SideNavContent = forwardRef(
  ({ style, children, ...props }, ref) => {
    return /* @__PURE__ */ jsx(
      "div",
      {
...
var SideNavGroup = forwardRef(
  ({ label, style, children, ...props }, ref) => {
    ...
    return /* @__PURE__ */ jsxs("div", { ref, style: groupStyle, ...props, children: [
...
var SideNavItem = forwardRef(
  ({ value, icon: Icon2, label, hasSubmenu, badge, disabled = false, href, style, onClick, ...props }, ref) => {
    ...
    const content = /* @__PURE__ */ jsxs(Fragment, { children: [
      Icon2 ? /* @__PURE__ */ jsx(Icon2, { size: 16, style: { flexShrink: 0 } }) : /* @__PURE__ */ jsx("span", { style: iconWrapperStyle, children: isActive && /* @__PURE__ */ jsx("span", { style: { width: 6, height: 6, borderRadius: "50%", backgroundColor: "#ffffff" } }) }),
      !collapsed && /* @__PURE__ */ jsxs(Fragment, { children: [
        /* @__PURE__ */ jsx("span", { style: { flex: 1, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }, children: label }),
        badge !== void 0 && badge > 0 && /* @__PURE__ */ jsx("span", { style: badgeStyle, children: badge > 99 ? "99+" : badge }),
        hasSubmenu && /* @__PURE__ */ jsx(ChevronRight, { size: 16, style: { color: "#a1a1aa", flexShrink: 0 } })
      ] })
    ] });
    if (href && !disabled) {
      return /* @__PURE__ */ jsx(
  ...
  ({ avatar, name, email, showExpand = false, style, onClick, ...props }, ref) => {
    ...
    return /* @__PURE__ */ jsxs(
      "div",
      {
        ...
        ...props,
        children: [
          /* @__PURE__ */ jsx("div", { style: avatarStyle, children: avatar ? /* @__PURE__ */ jsx("img", { src: avatar, alt: name, style: { width: "100%", height: "100%", objectFit: "cover" } }) : initials }),
          ...
          !collapsed && showExpand && /* @__PURE__ */ jsx(ChevronDown, { size: 16, style: { color: "#a1a1aa", flexShrink: 0 } })
        ]
      }
    );
  }
...
var CardHeader = forwardRef(
  ({ rightContent, style, children, ...props }, ref) => {
    ...
    return /* @__PURE__ */ jsxs("div", { ref, style: headerStyle, ...props, children: [
      ...
      rightContent && /* @__PURE__ */ jsx("div", { children: rightContent })
    ] });
  }
);
...
var CardTitle = forwardRef(
  ({ as: Component = "h3", style, children, ...props }, ref) => {
    ...
    return /* @__PURE__ */ jsx(Component, { ref, style: titleStyle, ...props, children });
  }
);
...
var CardContent = forwardRef(
  ({ style, children, ...props }, ref) => {
    ...
    return /* @__PURE__ */ jsx("div", { ref, style: contentStyle, ...props, children });
  }
);
...
var DividerWithLabel = forwardRef(
  ({
    label,
    ...
    return /* @__PURE__ */ jsxs("div", { ref, role: "separator", style: containerStyle, ...props, children: [
      labelPosition !== "left" && /* @__PURE__ */ jsx("span", { style: lineStyle }),
      /* @__PURE__ */ jsx("span", { style: labelStyle, children: label }),
      labelPosition !== "right" && /* @__PURE__ */ jsx("span", { style: lineStyle })
    ] });
  }
);
...
var PageHeader = forwardRef(
  ({
    ...
    return /* @__PURE__ */ jsxs("div", { ref, style: containerStyle, ...props, children: [
      breadcrumb && /* @__PURE__ */ jsx("div", { style: { marginBottom: HEADER_TOKENS.breadcrumb.marginBottom }, children: breadcrumb }),
      /* @__PURE__ */ jsxs("div", { style: headerRowStyle, children: [
        /* @__PURE__ */ jsxs("div", { style: { flex: 1, minWidth: 0 }, children: [
          /* @__PURE__ */ jsx(TitleTag, { style: titleStyle, children: title }),
...
var SectionHeader = forwardRef(
  ({ title, description, actions, bordered = false, style, ...props }, ref) => {
    ...
    return /* @__PURE__ */ jsxs("div", { ref, style: containerStyle, ...props, children: [
      ...
      actions && /* @__PURE__ */ jsx("div", { style: { display: "flex", alignItems: "center", gap: 8 }, children: actions })
    ] });
  }
);
SectionHeader.displayName = "SectionHeader";
var CardHeaderTitle = forwardRef(
  ({ title, subtitle, leading, trailing, style, ...props }, ref) => {
    ...
    return /* @__PURE__ */ jsxs("div", { ref, style: containerStyle, ...props, children: [
      ...
      /* @__PURE__ */ jsxs("div", { style: contentStyle, children: [
        /* @__PURE__ */ jsx("h4", { style: titleStyle, children: title }),
...
var PageFooter = forwardRef(
  ({ variant = "light", style, children, ...props }, ref) => {
    ...
    return /* @__PURE__ */ jsx("footer", { ref, style: footerStyle, ...props, children });
  }
);
PageFooter.displayName = "PageFooter";
var FooterSection = forwardRef(
  ({ title, style, children, ...props }, ref) => {
    ...
    return /* @__PURE__ */ jsxs("div", { ref, style: sectionStyle, ...props, children: [
      title && /* @__PURE__ */ jsx("h4", { style: titleStyle, children: title }),
      children
    ] });
  }
);
FooterSection.displayName = "FooterSection";
var FooterLink = forwardRef(
  ({ style, children, ...props }, ref) => {
    const [isHovered, setIsHovered] = React2.useState(false);
    const linkStyle = {
      fontSize: 14,
...
var FooterCopyright = forwardRef(
  ({ name = "Company", year = (/* @__PURE__ */ new Date()).getFullYear(), style, children, ...props }, ref) => {
    ...
    return /* @__PURE__ */ jsx("p", { ref, style: copyrightStyle, ...props, children: children || `\xA9 ${year} ${name}. All rights reserved.` });
  }
);
    ...
    if (loading) {
      return /* @__PURE__ */ jsxs("div", { ref, style: containerStyle, ...props, children: [
        /* @__PURE__ */ jsxs("div", { style: headerStyle, children: [
          /* @__PURE__ */ jsx("div", { style: { ...skeletonStyle, width: 80, height: 16 } }),
          Icon2 && /* @__PURE__ */ jsx("div", { style: { ...skeletonStyle, width: currentSize.iconSize, height: currentSize.iconSize, borderRadius: 8 } })
        ] }),
        /* @__PURE__ */ jsx("div", { style: { ...skeletonStyle, width: 120, height: currentSize.valueSize } }),
        /* @__PURE__ */ jsx("div", { style: { ...skeletonStyle, width: 60, height: 16, marginTop: 8 } })
      ] });
    }
    return /* @__PURE__ */ jsxs("div", { ref, style: containerStyle, ...props, children: [
      /* @__PURE__ */ jsxs("div", { style: headerStyle, children: [
      ...
      (trend !== void 0 || trendLabel) && /* @__PURE__ */ jsxs("div", { style: trendStyle, children: [
        /* @__PURE__ */ jsx(TrendIcon, { size: 14 }),
...
var DataBlockGrid = forwardRef(
  ({ columns = 3, gap = 16, style, children, ...props }, ref) => {
    ...
    return /* @__PURE__ */ jsx("div", { ref, style: gridStyle, ...props, children });
  }
);
...
var Table = forwardRef(
  ({ striped = false, bordered = true, style, children, ...props }, ref) => {
    ...
    return /* @__PURE__ */ jsx("div", { style: wrapperStyle, children: /* @__PURE__ */ jsx("table", { ref, style: tableStyle, ...props, children }) });
  }
);
...
var TableHeader = forwardRef(
  ({ style, children, ...props }, ref) => {
    ...
    return /* @__PURE__ */ jsx("thead", { ref, style: headerStyle, ...props, children });
  }
);
TableHeader.displayName = "TableHeader";
var TableBody = forwardRef(
  ({ style, children, ...props }, ref) => {
    return /* @__PURE__ */ jsx("tbody", { ref, style, ...props, children });
  }
);
...
var TableHead = forwardRef(
  ({ sortDirection, sortable = false, style, children, onClick, ...props }, ref) => {
    ...
    return /* @__PURE__ */ jsx("th", { ref, style: thStyle, onClick: sortable ? onClick : void 0, ...props, children: /* @__PURE__ */ jsxs("span", { style: { display: "inline-flex", alignItems: "center" }, children: [
      children,
      sortable && /* @__PURE__ */ jsx("span", { style: sortIconStyle, children: sortDirection === "asc" ? "\u2191" : sortDirection === "desc" ? "\u2193" : "\u2195" })
    ] }) });
  }
);
...
var TableCell = forwardRef(
  ({ style, children, ...props }, ref) => {
    ...
    return /* @__PURE__ */ jsx("td", { ref, style: cellStyle, ...props, children });
  }
);
...
var TableFooter = forwardRef(
  ({ style, children, ...props }, ref) => {
    ...
    return /* @__PURE__ */ jsx("tfoot", { ref, style: footerStyle, ...props, children });
  }
);
...
var TableCaption = forwardRef(
  ({ style, children, ...props }, ref) => {
    ...
    return /* @__PURE__ */ jsx("caption", { ref, style: captionStyle, ...props, children });
  }
);
...
var TablePagination = ({
  ...
  return /* @__PURE__ */ jsxs("div", { style: containerStyle, children: [
    /* @__PURE__ */ jsxs("div", { style: leftSectionStyle, children: [
      /* @__PURE__ */ jsx("span", { style: labelStyle, children: "Rows per page" }),
      onRowsPerPageChange && /* @__PURE__ */ jsx(
        "select",
        {
          value: rowsPerPage,
      ...
      /* @__PURE__ */ jsxs("span", { style: statusStyle, children: [
        start,
        "-",
        end,
        " of ",
...
var Pagination = forwardRef(
  ({ style, children, ...props }, ref) => {
    ...
    return /* @__PURE__ */ jsx("nav", { ref, role: "navigation", "aria-label": "Pagination", style: navStyle, ...props, children });
  }
);
...
var PaginationEllipsis = forwardRef(
  ({ style, ...props }, ref) => {
    const ellipsisStyle = {
      display: "flex",
      alignItems: "center",
    ...
    return /* @__PURE__ */ jsx("span", { ref, style: ellipsisStyle, ...props, children: /* @__PURE__ */ jsx(MoreHorizontal, { size: 16 }) });
  }
);
PaginationEllipsis.displayName = "PaginationEllipsis";
var FullPagination = forwardRef(
  ({
    page,
    totalPages,
    onPageChange,
    ...
    return /* @__PURE__ */ jsxs(Pagination, { ref, style, ...props, children: [
      ...
      pageNumbers.map(
        (p, i) => p === "ellipsis" ? /* @__PURE__ */ jsx(PaginationEllipsis, {}, `ellipsis-${i}`) : /* @__PURE__ */ jsx(
          PaginationButton,
          {
            active: p === page,
...
var Item2 = forwardRef(
  ({
    ...
    const mainContent = /* @__PURE__ */ jsxs("div", { style: mainContentStyle, children: [
      (media || LeadingIcon) && /* @__PURE__ */ jsx("span", { style: mediaStyle, children: media || LeadingIcon && /* @__PURE__ */ jsx(LeadingIcon, { size: ITEM_TOKENS.media.iconSize }) }),
      /* @__PURE__ */ jsxs("div", { style: contentStyle, children: [
        header && /* @__PURE__ */ jsxs("div", { style: headerStyle, children: [
          /* @__PURE__ */ jsx("span", { children: header }),
          helperText && /* @__PURE__ */ jsx("span", { children: helperText })
        ] }),
        /* @__PURE__ */ jsx("p", { style: titleStyle, children: title }),
        description && /* @__PURE__ */ jsx("p", { style: descriptionStyle, children: description })
      ] }),
      (actions || showChevron) && /* @__PURE__ */ jsxs("span", { style: actionsStyle, children: [
        actions,
        showChevron && /* @__PURE__ */ jsx(ChevronRight, { size: 20 })
      ] })
    ] });
    const content = /* @__PURE__ */ jsxs(Fragment, { children: [
      mainContent,
      footer && /* @__PURE__ */ jsx("div", { style: footerStyle, children: footer }),
      showDivider && /* @__PURE__ */ jsx("hr", { style: dividerStyle })
    ] });
    const commonProps = {
      ref,
      role,
...
var List = forwardRef(
  ({ divided = false, role: roleProp = "list", style, children, ...props }, ref) => {
    ...
    const childrenWithDividers = divided ? React2.Children.toArray(children).flatMap(
      (child, index, array) => index < array.length - 1 ? [child, /* @__PURE__ */ jsx("hr", { style: {
        margin: 0,
        border: "none",
    ...
    return /* @__PURE__ */ jsx("div", { ref, role: roleProp, style: listStyle, ...props, children: childrenWithDividers });
  }
);
...
var Skeleton = forwardRef(
  ({
    ...
    return /* @__PURE__ */ jsx("div", { ref, style: skeletonStyle, ...props, children: animate && /* @__PURE__ */ jsx("div", { style: shimmerStyle }) });
  }
);
...
var SkeletonText = forwardRef(
  ({ lines = 3, gap = 8, lastLineWidth = "60%", style, ...props }, ref) => {
    ...
    return /* @__PURE__ */ jsx("div", { ref, style: containerStyle, ...props, children: Array.from({ length: lines }).map((_, i) => /* @__PURE__ */ jsx(
      Skeleton,
      {
        height: 16,
...
var SkeletonCard = forwardRef(
  ({ showImage = true, imageHeight = 160, style, ...props }, ref) => {
    ...
    return /* @__PURE__ */ jsxs("div", { ref, style: cardStyle, ...props, children: [
      showImage && /* @__PURE__ */ jsx(Skeleton, { width: "100%", height: imageHeight, radius: "none" }),
      /* @__PURE__ */ jsxs("div", { style: contentStyle, children: [
        /* @__PURE__ */ jsx(Skeleton, { width: "60%", height: 20 }),
        /* @__PURE__ */ jsx(SkeletonText, { lines: 2 }),
        /* @__PURE__ */ jsxs("div", { style: { display: "flex", gap: 8, marginTop: 8 }, children: [
          /* @__PURE__ */ jsx(Skeleton, { width: 80, height: 32, radius: "full" }),
          /* @__PURE__ */ jsx(Skeleton, { width: 80, height: 32, radius: "full" })
        ] })
      ] })
    ] });
...
var EmptyState = forwardRef(
  ({
    ...
    return /* @__PURE__ */ jsxs("div", { ref, style: containerStyle, ...props, children: [
      /* @__PURE__ */ jsx("div", { style: iconContainerStyle, children: /* @__PURE__ */ jsx(
        IconComponent,
        {
  ...
  ({
    ...
    return /* @__PURE__ */ jsxs(
      "div",
      {
        ...
        ...props,
        children: [
          /* @__PURE__ */ jsx("div", { style: trackStyle, children: /* @__PURE__ */ jsx("div", { style: fillStyle }) }),
          showLabel && !indeterminate && /* @__PURE__ */ jsxs("span", { style: labelStyle, children: [
            clampedValue,
            "%"
          ] })
        ]
    ...
    return /* @__PURE__ */ jsxs(
      "div",
      {
        ...
        children: [
          ...
          (showLabel || label) && /* @__PURE__ */ jsx("span", { style: labelStyle, children: label || `${clampedValue}%` })
        ]
      }
    );
  }
...
var Alert = forwardRef(
  ({
    ...
    return /* @__PURE__ */ jsx(AlertContext.Provider, { value: { fg: tokens.fg }, children: /* @__PURE__ */ jsxs("div", { ref, role: "alert", style: alertStyle, ...props, children: [
      IconComponent && /* @__PURE__ */ jsx(IconComponent, { size: 20, style: iconStyle }),
...
var AlertTitle = forwardRef(
  ({ style, children, ...props }, ref) => {
    ...
    return /* @__PURE__ */ jsx("h5", { ref, style: titleStyle, ...props, children });
  }
);
...
var ToastProvider = ({
  ...
  return /* @__PURE__ */ jsxs(ToastContext.Provider, { value: { toasts, addToast, removeToast }, children: [
    children,
    /* @__PURE__ */ jsx("div", { style: containerStyle, role: "region", "aria-label": "Notifications", children: toasts.map((toast) => /* @__PURE__ */ jsx(ToastItem, { toast, onDismiss: () => removeToast(toast.id) }, toast.id)) })
  ] });
};
...
var ToastItem = ({ toast, onDismiss }) => {
  ...
  return /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      "aria-atomic": "true",
      children: [
        /* @__PURE__ */ jsx("div", { style: iconStyle, children: variant === "default" ? /* @__PURE__ */ jsx(Circle, { size: 20, strokeWidth: 2, fill: "none" }) : /* @__PURE__ */ jsx(Icon2, { size: 20 }) }),
        /* @__PURE__ */ jsxs("div", { style: contentStyle, children: [
          /* @__PURE__ */ jsx("p", { style: titleStyle, children: toast.title }),
          toast.description && /* @__PURE__ */ jsx("p", { style: descriptionStyle, children: toast.description }),
        ...
        /* @__PURE__ */ jsx(
          "button",
          {
            ...
            children: /* @__PURE__ */ jsx(X, { size: TOAST_TOKENS.closeButton.size })
          }
        )
      ]
    }
...
var Banner = forwardRef(
  ({
    ...
    return /* @__PURE__ */ jsxs("div", { ref, role: "alert", style: containerStyle, ...props, children: [
      !hideIcon && /* @__PURE__ */ jsx(Icon2, { size: 20, style: iconStyle }),
      /* @__PURE__ */ jsxs("div", { style: contentStyle, children: [
        title && /* @__PURE__ */ jsx("p", { style: titleStyle, children: title }),
        children && /* @__PURE__ */ jsx("p", { style: messageStyle, children })
      ] }),
      /* @__PURE__ */ jsxs("div", { style: actionsStyle, children: [
        action && /* @__PURE__ */ jsx("button", { type: "button", style: actionButtonStyle, onClick: action.onClick, children: action.label }),
        dismissible && /* @__PURE__ */ jsx("button", { type: "button", style: closeButtonStyle, onClick: handleDismiss, children: /* @__PURE__ */ jsx(X, { size: 16 }) })
      ] })
    ] });
  }
);
Banner.displayName = "Banner";
var PromoBanner = forwardRef(
  ({
    ...
    return /* @__PURE__ */ jsxs("div", { ref, style: { ...containerStyle, position: "relative" }, ...props, children: [
      children,
      dismissible && /* @__PURE__ */ jsx("button", { type: "button", style: closeStyle, onClick: handleDismiss, children: /* @__PURE__ */ jsx(X, { size: 16 }) })
    ] });
  }
);
...
var Avatar = forwardRef(
  ({
    ...
    return /* @__PURE__ */ jsxs("span", { ref, style: avatarStyle, ...props, children: [
      ...
      ) : displayInitials ? displayInitials : /* @__PURE__ */ jsx(User, { size: sizeTokens.iconSize }),
      showStatus && /* @__PURE__ */ jsx("span", { style: statusStyle })
    ] });
  }
);
...
var AvatarGroup = forwardRef(
  ({
    ...
    return /* @__PURE__ */ jsxs("div", { ref, style: groupStyle, ...props, children: [
      remainingCount > 0 && /* @__PURE__ */ jsxs("span", { style: counterStyle, children: [
        "+",
        remainingCount
      ] }),
      visibleChildren.reverse().map((child, index) => /* @__PURE__ */ jsx("span", { style: itemStyle, children: React2.cloneElement(child, { size }) }, index))
    ] });
  }
);
      ...
      children: [
        /* @__PURE__ */ jsxs("div", { style: headerStyle, children: [
          /* @__PURE__ */ jsxs("div", { style: { display: "flex", alignItems: "center", gap: 12 }, children: [
            ...
            showCounter && /* @__PURE__ */ jsxs("span", { style: {
            ...
            currentImage.name && /* @__PURE__ */ jsx("span", { style: {
          ...
          /* @__PURE__ */ jsxs("div", { style: { display: "flex", alignItems: "center", gap: 12 }, children: [
            enableZoom && /* @__PURE__ */ jsxs("div", { style: { display: "flex", alignItems: "center", gap: LIGHTBOX_TOKENS.zoom.gap }, children: [
              /* @__PURE__ */ jsx(
                "button",
                {
                  type: "button",
        ...
        /* @__PURE__ */ jsxs(
          "div",
          {
            ...
            children: [
              images.length > 1 && variant === "image" && /* @__PURE__ */ jsx(
                "button",
                {
                  type: "button",
              ...
              annotation && /* @__PURE__ */ jsxs("div", { style: annotationCardStyle, children: [
                ...
                annotation.description && /* @__PURE__ */ jsx("p", { style: {
                  margin: "0 0 8px",
                  fontSize: 13,
                  color: "#71717a",
                  lineHeight: 1.5
                }, children: annotation.description }),
                annotation.tags && annotation.tags.length > 0 && /* @__PURE__ */ jsx("div", { style: { display: "flex", flexWrap: "wrap", gap: 4 }, children: annotation.tags.map((tag, index) => /* @__PURE__ */ jsx(
                  "span",
                  {
                    style: {
                      padding: "2px 8px",
        ...
        showThumbnails && variant === "image" && images.length > 1 && /* @__PURE__ */ jsx("div", { style: thumbnailsContainerStyle, children: /* @__PURE__ */ jsx("div", { ref: thumbnailsRef, style: thumbnailsScrollStyle, children: images.map((image, index) => /* @__PURE__ */ jsx(
          "img",
          {
  ...
  ({
      ...
      return /* @__PURE__ */ jsxs(
        "div",
        {
          ...
          children: [
            ...
            instanceSlot && /* @__PURE__ */ jsx("div", { style: MEDIA_HERO_TOKENS.instanceSlot, children: instanceSlot }),
            showAllButton && images.length > 1 && /* @__PURE__ */ jsx("div", { style: showAllButtonWrapperStyle, children: /* @__PURE__ */ jsxs(
              "button",
              {
                type: "button",
                style: {
      ...
      return /* @__PURE__ */ jsxs(
        "div",
        {
          ...
          children: [
                ...
                children: images.map((image, index) => /* @__PURE__ */ jsxs(
                  "div",
                  {
                    ...
                    children: [
                      ...
                      instanceSlot && index === carouselIndex && /* @__PURE__ */ jsx("div", { style: {
            ...
            showCounter && /* @__PURE__ */ jsxs("div", { style: {
              position: "absolute",
              bottom: 16,
              right: 16,
    ...
    const renderGrid = () => {
      if (gridImages.length === 1) {
        return /* @__PURE__ */ jsx("div", { style: { height: "100%", position: "relative" }, children: /* @__PURE__ */ jsx(
          "img",
          {
      ...
      if (gridImages.length === 2) {
        return /* @__PURE__ */ jsx("div", { style: { display: "flex", gap, height: "100%" }, children: gridImages.map((img, i) => /* @__PURE__ */ jsxs(
          "div",
          {
            ...
            children: [
              ...
              i === 1 && images.length > 2 && showAllButton && /* @__PURE__ */ jsx(
                "div",
                {
                  style: {
                    position: "absolute",
      ...
      if (gridImages.length === 3) {
        return /* @__PURE__ */ jsxs("div", { style: { display: "flex", gap, height: "100%" }, children: [
          /* @__PURE__ */ jsx(
            "div",
            {
          ...
          /* @__PURE__ */ jsx("div", { style: { width: "40%", display: "flex", flexDirection: "column", gap }, children: gridImages.slice(1).map((img, i) => {
            ...
            return /* @__PURE__ */ jsxs(
              "div",
              {
                ...
                children: [
                  ...
                  isLastThumbnail && images.length > gridImages.length && showAllButton && /* @__PURE__ */ jsx(
                    "div",
                    {
                      style: {
                        position: "absolute",
      ...
      if (gridImages.length === 4) {
        return /* @__PURE__ */ jsxs("div", { style: { display: "flex", gap, height: "100%" }, children: [
          ...
          /* @__PURE__ */ jsx("div", { style: { width: "40%", display: "flex", flexDirection: "column", gap }, children: gridImages.slice(1).map((img, i) => /* @__PURE__ */ jsx(
            "div",
            {
              style: { flex: 1, overflow: "hidden", position: "relative" },
              onMouseEnter: () => setIsHovered(i + 1),
      ...
      return /* @__PURE__ */ jsxs("div", { style: { display: "flex", gap, height: "100%" }, children: [
        ...
        /* @__PURE__ */ jsx("div", { style: {
          ...
          gap
        }, children: gridImages.slice(1, 5).map((img, i) => /* @__PURE__ */ jsxs(
          "div",
          {
            ...
            children: [
              ...
              i === 3 && images.length > 5 && showAllButton && /* @__PURE__ */ jsx(
                "div",
                {
                  style: {
                    position: "absolute",
...
var Carousel = forwardRef(
  ({
    ...
    const slides = React2.Children.toArray(children);
    ...
    return /* @__PURE__ */ jsxs(
      "div",
      {
        ...
        ...props,
        children: [
          /* @__PURE__ */ jsx("div", { style: viewportStyle, children: /* @__PURE__ */ jsx("div", { ref: trackRef, style: trackStyle, children: slides.map((slide, index) => /* @__PURE__ */ jsx("div", { style: slideStyle, children: slide }, index)) }) }),
          showArrows && totalSlides > slidesToShow && !isVertical && /* @__PURE__ */ jsxs(Fragment, { children: [
            /* @__PURE__ */ jsx(
              "button",
              {
                type: "button",
          ...
          showCounter && /* @__PURE__ */ jsxs("div", { style: counterStyle, children: [
            currentSlide,
            " of ",
            totalSlides
          ] }),
          showDots && totalSlides > slidesToShow && !showThumbnails && /* @__PURE__ */ jsx("div", { style: dotsContainerStyle, children: Array.from({ length: totalSlides }).map((_, index) => /* @__PURE__ */ jsx(
            "button",
            {
              type: "button",
          ...
          showThumbnails && totalSlides > slidesToShow && /* @__PURE__ */ jsx("div", { style: thumbnailsContainerStyle, children: slides.map((slide, index) => /* @__PURE__ */ jsx(
            "button",
            {
              type: "button",
              style: getThumbnailStyle(index),
              onClick: () => goTo(index),
              "aria-label": `Go to slide ${index + 1}`,
              children: React2.isValidElement(slide) && React2.cloneElement(slide, {
                style: {
                  width: "100%",
                  height: "100%",
                  objectFit: "cover"
...
var CarouselItem = forwardRef(
  ({ style, children, ...props }, ref) => {
    return /* @__PURE__ */ jsx("div", { ref, style: { width: "100%", ...style }, ...props, children });
  }
);
...
var Calendar = forwardRef(
  ({
    ...
    return /* @__PURE__ */ jsxs("div", { ref, style: containerStyle, ...props, children: [
      /* @__PURE__ */ jsxs("div", { style: headerStyle, children: [
        /* @__PURE__ */ jsx("button", { type: "button", style: navButtonStyle, onClick: prevMonth, children: /* @__PURE__ */ jsx(ChevronLeft, { size: 20 }) }),
        /* @__PURE__ */ jsxs("span", { style: titleStyle, children: [
          MONTHS[currentMonth.getMonth()],
          " ",
          currentMonth.getFullYear()
        ] }),
        /* @__PURE__ */ jsx("button", { type: "button", style: navButtonStyle, onClick: nextMonth, children: /* @__PURE__ */ jsx(ChevronRight, { size: 20 }) })
      ] }),
      /* @__PURE__ */ jsx("div", { style: weekdayRowStyle, children: DAYS.map((day) => /* @__PURE__ */ jsx("div", { style: weekdayStyle, children: day }, day)) }),
      /* @__PURE__ */ jsxs("div", { style: gridStyle, children: [
        Array.from({ length: firstDay }).map((_, i) => /* @__PURE__ */ jsx("div", { style: { width: CALENDAR_TOKENS.cell.size, height: CALENDAR_TOKENS.cell.size } }, `empty-${i}`)),
...
var DatePicker = forwardRef(
  ({
    ...
    return /* @__PURE__ */ jsxs("div", { ref: containerRef, style: containerStyle, ...props, children: [
      ...
      isOpen && /* @__PURE__ */ jsx("div", { style: dropdownStyle, children: /* @__PURE__ */ jsx(
        Calendar,
        {
          value: selectedDate,
    ...
    return /* @__PURE__ */ jsxs("div", { ref, style: containerStyle, ...props, children: [
      /* @__PURE__ */ jsxs(
        "div",
        {
          ...
          tabIndex: disabled ? -1 : 0,
          children: [
            /* @__PURE__ */ jsx("div", { style: trackStyle }),
            /* @__PURE__ */ jsx("div", { style: filledStyle }),
            /* @__PURE__ */ jsx("div", { style: thumbStyle })
          ]
        }
      ),
      showValue && /* @__PURE__ */ jsx("span", { style: valueStyle, children: value })
    ] });
  }
);
...
var RangeSlider = forwardRef(
  ({
    ...
    return /* @__PURE__ */ jsx("div", { ref, style: containerStyle, ...props, children: /* @__PURE__ */ jsxs("div", { ref: trackRef, style: { position: "absolute", inset: 0 }, children: [
      /* @__PURE__ */ jsxs("div", { style: trackWrapperStyle, children: [
        /* @__PURE__ */ jsx("div", { style: trackStyle }),
        /* @__PURE__ */ jsx("div", { style: filledStyle })
      ] }),
      /* @__PURE__ */ jsx("div", { style: getThumbStyle(0), onMouseDown: handleMouseDown(0) }),
      /* @__PURE__ */ jsx("div", { style: getThumbStyle(1), onMouseDown: handleMouseDown(1) })
    ] }) });
  }
);
  ...
  ({
      ...
      return /* @__PURE__ */ jsx(
        "span",
        {
          ...
          children: isHalfFilled ? (
            ...
            /* @__PURE__ */ jsxs("span", { style: { position: "relative", display: "flex" }, children: [
              /* @__PURE__ */ jsx(Star, { size: starSize, fill: RATING_TOKENS.star.colorEmpty, stroke: RATING_TOKENS.star.colorEmpty }),
              /* @__PURE__ */ jsx("span", { style: {
                position: "absolute",
                top: 0,
                left: 0,
                width: "50%",
                overflow: "hidden"
              }, children: /* @__PURE__ */ jsx(Star, { size: starSize, fill: color, stroke: color }) })
            ] })
          ) : filledIcon && isFilled ? filledIcon : emptyIcon && !isFilled ? emptyIcon : /* @__PURE__ */ jsx(
            Star,
            {
              size: starSize,
    ...
    return /* @__PURE__ */ jsxs(
      "div",
      {
        ...
        ...props,
        children: [
          /* @__PURE__ */ jsx("div", { style: starsStyle, children: Array.from({ length: max }).map((_, i) => renderStar(i)) }),
          showValue && /* @__PURE__ */ jsx("span", { style: valueStyle, children: displayValue.toFixed(allowHalf ? 1 : 0) })
        ]
      }
    );
  }
...
var RatingDisplay = forwardRef(
  ({ value, count, size = "sm", style, ...props }, ref) => {
    ...
    return /* @__PURE__ */ jsxs("div", { ref, style: containerStyle, ...props, children: [
      /* @__PURE__ */ jsx(Star, { size: RATING_TOKENS.sizes[size], fill: RATING_TOKENS.star.color, stroke: RATING_TOKENS.star.color }),
      /* @__PURE__ */ jsx("span", { style: valueStyle, children: value.toFixed(1) }),
      count !== void 0 && /* @__PURE__ */ jsxs("span", { style: countStyle, children: [
        "(",
...
var ColorPicker = forwardRef(
  ({
    ...
    return /* @__PURE__ */ jsxs("div", { ref: containerRef, style: wrapperStyle, ...props, children: [
      label && /* @__PURE__ */ jsx("label", { style: { display: "block", marginBottom: 6, fontSize: 14, fontWeight: 500, color: "#18181b" }, children: label }),
      /* @__PURE__ */ jsxs(
        "div",
        {
          ...
          onClick: () => !disabled && setIsOpen(!isOpen),
          children: [
            /* @__PURE__ */ jsx("div", { style: swatchStyle }),
            /* @__PURE__ */ jsx("span", { style: { fontSize: 13, fontFamily: "monospace", color: "#3f3f46" }, children: color.toUpperCase() }),
            /* @__PURE__ */ jsx(Pipette, { size: 16, style: { color: "#71717a", marginLeft: "auto" } })
          ]
        }
      ),
      isOpen && /* @__PURE__ */ jsxs("div", { style: dropdownStyle, children: [
        /* @__PURE__ */ jsx(
          "input",
          {
            type: "color",
        ...
        showPresets && /* @__PURE__ */ jsx("div", { style: presetsGridStyle, children: presets.map((presetColor) => /* @__PURE__ */ jsx(
          "button",
          {
            type: "button",
...
var ToggleGroup = forwardRef(
  ({
    ...
    return /* @__PURE__ */ jsx(ToggleGroupContext.Provider, { value: { value, onValueChange: handleValueChange, multiple }, children: /* @__PURE__ */ jsx(
      "div",
      {
        ref,
        role: "group",
        ...
        children: React2.Children.map(children, (child) => {
          if (React2.isValidElement(child)) {
            return React2.cloneElement(child, { size });
          }
          return child;
        })
      }
...
var Stepper = forwardRef(
  ({ currentStep, orientation = "horizontal", style, children, ...props }, ref) => {
    ...
    return /* @__PURE__ */ jsx(StepperContext.Provider, { value: { currentStep, orientation, totalSteps }, children: /* @__PURE__ */ jsx("div", { ref, style: containerStyle, role: "list", ...props, children: React2.Children.map(children, (child, index) => {
      if (React2.isValidElement(child)) {
        return React2.cloneElement(child, { index });
      }
      return child;
    }) }) });
  }
...
var StepperStep = forwardRef(
  ({ label, description, status: statusProp, icon, index = 0, style, ...props }, ref) => {
    ...
    return /* @__PURE__ */ jsx("div", { ref, role: "listitem", style: stepStyle, ...props, children: orientation === "horizontal" ? /* @__PURE__ */ jsxs(Fragment, { children: [
      /* @__PURE__ */ jsxs("div", { style: indicatorRowStyle, children: [
        /* @__PURE__ */ jsx("div", { style: indicatorStyle, children: status === "completed" ? /* @__PURE__ */ jsx(Check, { size: 16 }) : icon || index + 1 }),
        !isLast && /* @__PURE__ */ jsx("div", { style: connectorStyle })
      ] }),
      /* @__PURE__ */ jsxs("div", { style: contentStyle, children: [
...
var Timeline = forwardRef(
  ({ position = "left", style, children, ...props }, ref) => {
    ...
    return /* @__PURE__ */ jsx("div", { ref, style: timelineStyle, role: "list", ...props, children: React2.Children.map(children, (child, index) => {
      if (React2.isValidElement(child)) {
        const isAlternate = position === "alternate";
        const itemPosition = isAlternate ? index % 2 === 0 ? "left" : "right" : position;
        return React2.cloneElement(child, {
          position: itemPosition,
          isLast: index === React2.Children.count(children) - 1
        });
      }
      return child;
    }) });
  ...
  ({
    ...
    return /* @__PURE__ */ jsxs(
      "div",
      {
        ...
        ...props,
        children: [
          /* @__PURE__ */ jsxs("div", { style: nodeContainerStyle, children: [
            /* @__PURE__ */ jsx(
              "div",
              {
                style: nodeStyle,
                "aria-label": status === "success" ? "Completed" : status === "error" ? "Error" : status === "active" ? "In progress" : "Pending",
                children: Icon2 ? /* @__PURE__ */ jsx(Icon2, { size: 14, strokeWidth: status === "active" ? 2 : 2.5 }) : /* @__PURE__ */ jsx("div", { style: innerDotStyle })
              }
            ),
            !isLast && /* @__PURE__ */ jsx("div", { style: connectorStyle })
          ] }),
          /* @__PURE__ */ jsxs("div", { style: contentStyle, children: [
            title && /* @__PURE__ */ jsx("h4", { style: titleStyle, children: title }),
            description && /* @__PURE__ */ jsx("p", { style: descriptionStyle, children: description }),
            time && /* @__PURE__ */ jsx("p", { style: timeStyle, children: time }),
            children
          ] })
        ]
      }
  ...
  ({
    ...
    const renderRightElement = () => {
      ...
      if (rightElement === "remove") {
        return /* @__PURE__ */ jsxs(Fragment, { children: [
          showDivider && /* @__PURE__ */ jsx("span", { style: dividerStyle }),
          /* @__PURE__ */ jsx(
            "span",
            {
              role: "button",
      ...
      if (rightElement === "dropdown") {
        return /* @__PURE__ */ jsxs(Fragment, { children: [
          showDivider && /* @__PURE__ */ jsx("span", { style: dividerStyle }),
          /* @__PURE__ */ jsx("span", { style: rightElementStyle, children: active ? /* @__PURE__ */ jsx(ChevronUp, { size: sizeTokens.iconSize - 2 }) : /* @__PURE__ */ jsx(ChevronDown, { size: sizeTokens.iconSize - 2 }) })
        ] });
      }
      if (rightElement === "count" && count !== void 0) {
        return /* @__PURE__ */ jsxs(Fragment, { children: [
          showDivider && /* @__PURE__ */ jsx("span", { style: dividerStyle }),
          /* @__PURE__ */ jsxs("span", { style: rightElementStyle, children: [
            "(",
            count,
            ")"
          ] })
      ...
      return /* @__PURE__ */ jsxs(Fragment, { children: [
        showDivider && /* @__PURE__ */ jsx("span", { style: dividerStyle }),
        /* @__PURE__ */ jsx("span", { style: rightElementStyle, children: rightElement })
      ] });
    };
    return /* @__PURE__ */ jsxs(
      "button",
      {
        ...
        ...props,
        children: [
          LeftIcon && /* @__PURE__ */ jsx(LeftIcon, { size: sizeTokens.iconSize }),
          children,
          renderRightElement()
        ]
      }
...
var ChipGroup = forwardRef(
  ({ value, onValueChange, multiple = false, style, children, ...props }, ref) => {
    ...
    return /* @__PURE__ */ jsx("div", { ref, role: "group", style: groupStyle, ...props, children });
  }
);
  ...
  ({
    ...
    return /* @__PURE__ */ jsxs(
      "a",
      {
        ...
        children: [
          children,
          isExternalLink && external && /* @__PURE__ */ jsx(ExternalLink, { size: size === "sm" ? 12 : size === "lg" ? 16 : 14 })
        ]
      }
    );
  }
  ...
  ({
      ...
      return /* @__PURE__ */ jsxs(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxs("div", { style: { padding: PROPERTY_CARD_TOKENS.card.contentPadding }, children: [
              /* @__PURE__ */ jsx("div", { style: { height: 16, width: "80%", backgroundColor: "#f4f4f5", borderRadius: 4, marginBottom: 8 } }),
              /* @__PURE__ */ jsx("div", { style: { height: 12, width: "50%", backgroundColor: "#f4f4f5", borderRadius: 3, marginBottom: 12 } }),
              /* @__PURE__ */ jsx("div", { style: { display: "flex", gap: 8, marginBottom: 12 }, children: [1, 2, 3, 4].map((i) => /* @__PURE__ */ jsx("div", { style: { height: 36, width: 80, backgroundColor: "#f4f4f5", borderRadius: 8 } }, i)) }),
              [1, 2, 3].map((i) => /* @__PURE__ */ jsxs("div", { style: { display: "flex", justifyContent: "space-between", marginBottom: 8 }, children: [
                /* @__PURE__ */ jsx("div", { style: { height: 12, width: "40%", backgroundColor: "#f4f4f5", borderRadius: 3 } }),
                /* @__PURE__ */ jsx("div", { style: { height: 12, width: "25%", backgroundColor: "#f4f4f5", borderRadius: 3 } })
              ] }, i))
            ] })
          ]
        }
    ...
    return /* @__PURE__ */ jsxs(
      "div",
      {
        ...
        ...props,
        children: [
          /* @__PURE__ */ jsxs("div", { style: imageContainerStyle, children: [
            image ? /* @__PURE__ */ jsx("img", { src: image, alt: title, style: imageStyle }) : /* @__PURE__ */ jsx("div", { style: {
              ...imageStyle,
              backgroundColor: "#f4f4f5",
              display: "flex",
              alignItems: "center",
              justifyContent: "center"
            }, children: /* @__PURE__ */ jsx(Building, { size: 48, color: "#d4d4d8" }) }),
            type && /* @__PURE__ */ jsx("span", { style: typeBadgeStyle, children: type }),
            displayValueLabels.length > 0 && /* @__PURE__ */ jsx("div", { style: {
              position: "absolute",
              top: 12,
              left: type ? 110 : 12,
              display: "flex",
              gap: 6,
              zIndex: 2
            }, children: displayValueLabels.map((label) => /* @__PURE__ */ jsx("span", { style: getValueLabelStyle(label), children: PROPERTY_CARD_TOKENS.valueLabel[label].label }, label)) }),
            showFavorite && /* @__PURE__ */ jsx(
              "button",
              {
                type: "button",
          ...
          /* @__PURE__ */ jsxs("div", { style: contentStyle, children: [
            /* @__PURE__ */ jsxs("div", { style: { display: "flex", alignItems: "center", gap: 12, marginBottom: 4 }, children: [
              /* @__PURE__ */ jsx("h3", { style: {
                margin: 0,
              ...
              status && /* @__PURE__ */ jsx("span", { style: getStatusStyle(status), children: PROPERTY_CARD_TOKENS.status[status].label })
            ] }),
            /* @__PURE__ */ jsx("div", { style: {
            ...
            isProject && (deliveryDate || constructionStatus) ? /* @__PURE__ */ jsxs("div", { style: {
            ...
            ] }) : hasFeatures ? /* @__PURE__ */ jsxs("div", { style: { display: "flex", flexWrap: "wrap", gap: 8, marginBottom: 20 }, children: [
              category && /* @__PURE__ */ jsxs("span", { style: featurePillStyle, children: [
                /* @__PURE__ */ jsx(Home, { size: 16 }),
                category
              ] }),
              bedrooms !== void 0 && /* @__PURE__ */ jsxs("span", { style: featurePillStyle, children: [
                /* @__PURE__ */ jsx(Bed, { size: 16 }),
                bedrooms,
                " beds"
              ] }),
              bathrooms !== void 0 && /* @__PURE__ */ jsxs("span", { style: featurePillStyle, children: [
                /* @__PURE__ */ jsx(Bath, { size: 16 }),
                bathrooms,
                " baths"
              ] }),
              area !== void 0 && /* @__PURE__ */ jsxs("span", { style: featurePillStyle, children: [
                /* @__PURE__ */ jsx(Maximize, { size: 16 }),
                area,
                " m\xB2"
              ] })
            ] }) : null,
            /* @__PURE__ */ jsxs("div", { style: {
              ...
              yieldPercent !== void 0 && /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsx("div", { style: {
                  fontSize: PROPERTY_CARD_TOKENS.priceLabel.fontSize,
                  color: PROPERTY_CARD_TOKENS.priceLabel.color,
                  marginBottom: 4
            ...
            infoRows.length > 0 && /* @__PURE__ */ jsx("div", { style: {
              ...
              gap: 16,
              opacity: isSold ? 0.5 : 1
            }, children: infoRows.map((row, index) => /* @__PURE__ */ jsxs(
              "div",
              {
                style: {
                  display: "flex",
...
var PropertyCardGrid = forwardRef(
